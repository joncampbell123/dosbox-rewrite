; Pentium MMX test instruction set

    cpu     pentium FPU Undoc Obsolete mmx cyrix
...
; MMX
    ...
    punpcklbw   mm0,mm1
    punpcklbw   mm0,[si]
    punpcklbw   mm0,[bx+si+0x12]
    punpcklbw   mm0,[ebx*4+esi+0x12345678]

    punpcklwd   mm4,mm5
    punpcklwd   mm0,mm1
    punpcklwd   mm0,[si]
    punpcklwd   mm0,[bx+si+0x12]
    punpcklwd   mm0,[ebx*4+esi+0x12345678]

    punpckldq   mm4,mm5
    punpckldq   mm0,mm1
    punpckldq   mm0,[si]
    punpckldq   mm0,[bx+si+0x12]
    punpckldq   mm0,[ebx*4+esi+0x12345678]

    packsswb    mm4,mm5
    packsswb    mm0,mm1
    packsswb    mm0,[si]
    packsswb    mm0,[bx+si+0x12]
    packsswb    mm0,[ebx*4+esi+0x12345678]

    pcmpgtb     mm4,mm5
    pcmpgtb     mm0,mm1
    pcmpgtb     mm0,[si]
    pcmpgtb     mm0,[bx+si+0x12]
    pcmpgtb     mm0,[ebx*4+esi+0x12345678]

    pcmpgtw     mm4,mm5
    pcmpgtw     mm0,mm1
    pcmpgtw     mm0,[si]
    pcmpgtw     mm0,[bx+si+0x12]
    pcmpgtw     mm0,[ebx*4+esi+0x12345678]

    pcmpgtd     mm4,mm5
    pcmpgtd     mm0,mm1
    pcmpgtd     mm0,[si]
    pcmpgtd     mm0,[bx+si+0x12]
    pcmpgtd     mm0,[ebx*4+esi+0x12345678]

    packuswb    mm4,mm5
    packuswb    mm0,mm1
    packuswb    mm0,[si]
    packuswb    mm0,[bx+si+0x12]
    packuswb    mm0,[ebx*4+esi+0x12345678]

    punpckhbw   mm4,mm5
    punpckhbw   mm0,mm1
    punpckhbw   mm0,[si]
    punpckhbw   mm0,[bx+si+0x12]
    punpckhbw   mm0,[ebx*4+esi+0x12345678]

    punpckhwd   mm4,mm5
    punpckhwd   mm0,mm1
    punpckhwd   mm0,[si]
    punpckhwd   mm0,[bx+si+0x12]
    punpckhwd   mm0,[ebx*4+esi+0x12345678]

    punpckhdq   mm4,mm5
    punpckhdq   mm0,mm1
    punpckhdq   mm0,[si]
    punpckhdq   mm0,[bx+si+0x12]
    punpckhdq   mm0,[ebx*4+esi+0x12345678]

    packssdw    mm4,mm5
    packssdw    mm0,mm1
    packssdw    mm0,[si]
    packssdw    mm0,[bx+si+0x12]
    packssdw    mm0,[ebx*4+esi+0x12345678]
...
; Cyrix 6x86MX
    ...
    pmvzb       mm0,mm1
    pmvzb       mm0,[si]
    ; YASM won't encode 6x86MX PMULHRW
    db          0x0F,0x59,0xC0          ; PMULHRW mm0,mm0
    db          0x0F,0x59,0xC1          ; PMULHRW mm0,mm1
    db          0x0F,0x59,0x00          ; PMULHRW [BX+SI],mm0
    pmvnzb      mm0,mm1
    pmvnzb      mm0,[si]
    pmvlzb      mm0,mm1
    pmvlzb      mm0,[si]
