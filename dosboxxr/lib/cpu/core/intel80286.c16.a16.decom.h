...
/* Opcodes starting with 0Fh 00h */
                switch (mrm.byte) {
                    ...
                    case 0x87: /* 0Fh 00h 87h SLDTw w(r/m) mod=2 reg=0 rm=7      spec: 0x0F 0x00 mod/reg/rm /0 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SLDTw %s%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0x8F: /* 0Fh 00h 8Fh STRw w(r/m) mod=2 reg=1 rm=7      spec: 0x0F 0x00 mod/reg/rm /1 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"STRw %s%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0x97: /* 0Fh 00h 97h LLDTw w(r/m) mod=2 reg=2 rm=7      spec: 0x0F 0x00 mod/reg/rm /2 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LLDTw %s%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0x9F: /* 0Fh 00h 9Fh LTRw w(r/m) mod=2 reg=3 rm=7      spec: 0x0F 0x00 mod/reg/rm /3 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LTRw %s%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0xA7: /* 0Fh 00h A7h VERRw w(r/m) mod=2 reg=4 rm=7      spec: 0x0F 0x00 mod/reg/rm /4 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"VERRw %s%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0xAF: /* 0Fh 00h AFh VERWw w(r/m) mod=2 reg=5 rm=7      spec: 0x0F 0x00 mod/reg/rm /5 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"VERWw %s%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                        break;
...
/* Opcodes starting with 0Fh 01h */
                switch (mrm.byte) {
                    ...
                    case 0x87: /* 0Fh 01h 87h SGDTw w(r/m) mod=2 reg=0 rm=7      spec: 0x0F 0x01 mod/reg/rm /0 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SGDTw %s%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0x8F: /* 0Fh 01h 8Fh SIDTw w(r/m) mod=2 reg=1 rm=7      spec: 0x0F 0x01 mod/reg/rm /1 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SIDTw %s%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0x97: /* 0Fh 01h 97h LGDTw w(r/m) mod=2 reg=2 rm=7      spec: 0x0F 0x01 mod/reg/rm /2 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LGDTw %s%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0x9F: /* 0Fh 01h 9Fh LIDTw w(r/m) mod=2 reg=3 rm=7      spec: 0x0F 0x01 mod/reg/rm /3 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LIDTw %s%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0xA7: /* 0Fh 01h A7h SMSWw w(r/m) mod=2 reg=4 rm=7      spec: 0x0F 0x01 mod/reg/rm /4 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SMSWw %s%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0xB7: /* 0Fh 01h B7h LMSWw w(r/m) mod=2 reg=6 rm=7      spec: 0x0F 0x01 mod/reg/rm /6 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LMSWw %s%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                        break;
...
/* End of opcodes starting with 0Fh 01h */
            ...
            case 0x02: /* 0Fh 02h LARw w(reg),w(r/m)      spec: 0x0F 0x02 mod/reg/rm */
                IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LARw %s,%s%s",CPUregsN[2][mrm.reg()],IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                break;
            case 0x03: /* 0Fh 03h LSLw w(reg),w(r/m)      spec: 0x0F 0x03 mod/reg/rm */
                IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LSLw %s,%s%s",CPUregsN[2][mrm.reg()],IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                break;
            /* opcode 0Fh 04h  not defined */
            case 0x05: /* 0Fh 05h LOADALL286       spec: 0x0F 0x05 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LOADALL286");
                break;
...
/* End of opcodes starting with 0Fh */
    ...
    case 0x62: /* 62h BOUNDw w(reg),w(r/m)      spec: 0x62 mod/reg/rm mod!=3 */
        IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"BOUNDw %s,%s%s",CPUregsN[2][mrm.reg()],IPDecPrint16(mrm,disp,2,RC_REG,"w"));
        break;
    case 0x63: /* 63h ARPLw w(r/m),w(reg)      spec: 0x63 mod/reg/rm */
        IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ARPLw %s%s,%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
        break;
    /* opcode 64h  not defined */
    /* opcode 65h  not defined */
    /* opcode 66h  not defined */
    /* opcode 67h  not defined */
    ...
    case 0x69: /* 69h IMULw w(reg),w(r/m),w(i)      spec: 0x69 mod/reg/rm iw */
        IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        imm=IPFcodeW();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IMULw %s,%s%s,0x%04lX",CPUregsN[2][mrm.reg()],IPDecPrint16(mrm,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
        break;
    ...
    case 0x6B: /* 6Bh IMULb w(reg),w(r/m),b(i)      spec: 0x6B mod/reg/rm ib */
        IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IMULb %s,%s%s,0x%02lX",CPUregsN[2][mrm.reg()],IPDecPrint16(mrm,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
        break;
...
/* Opcodes starting with C0h */
        switch (mrm.reg()) {
            case 0: /* C0h 00h ROLb b(r/m),b(i) reg=0      spec: 0xC0 mod/reg/rm /0 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROLb %s%s,0x%02lX",IPDecPrint16(mrm,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 1: /* C0h 08h RORb b(r/m),b(i) reg=1      spec: 0xC0 mod/reg/rm /1 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RORb %s%s,0x%02lX",IPDecPrint16(mrm,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 2: /* C0h 10h RCLb b(r/m),b(i) reg=2      spec: 0xC0 mod/reg/rm /2 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCLb %s%s,0x%02lX",IPDecPrint16(mrm,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 3: /* C0h 18h RCRb b(r/m),b(i) reg=3      spec: 0xC0 mod/reg/rm /3 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCRb %s%s,0x%02lX",IPDecPrint16(mrm,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 4: /* C0h 20h SHLb b(r/m),b(i) reg=4      spec: 0xC0 mod/reg/rm /4 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHLb %s%s,0x%02lX",IPDecPrint16(mrm,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 5: /* C0h 28h SHRb b(r/m),b(i) reg=5      spec: 0xC0 mod/reg/rm /5 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHRb %s%s,0x%02lX",IPDecPrint16(mrm,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 6: /* C0h 30h SALb b(r/m),b(i) reg=6      spec: 0xC0 mod/reg/rm /6 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SALb %s%s,0x%02lX",IPDecPrint16(mrm,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 7: /* C0h 38h SARb b(r/m),b(i) reg=7      spec: 0xC0 mod/reg/rm /7 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SARb %s%s,0x%02lX",IPDecPrint16(mrm,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with C1h */
        switch (mrm.reg()) {
            case 0: /* C1h 00h ROLw w(r/m),b(i) reg=0      spec: 0xC1 mod/reg/rm /0 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROLw %s%s,0x%02lX",IPDecPrint16(mrm,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 1: /* C1h 08h RORw w(r/m),b(i) reg=1      spec: 0xC1 mod/reg/rm /1 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RORw %s%s,0x%02lX",IPDecPrint16(mrm,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 2: /* C1h 10h RCLw w(r/m),b(i) reg=2      spec: 0xC1 mod/reg/rm /2 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCLw %s%s,0x%02lX",IPDecPrint16(mrm,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 3: /* C1h 18h RCRw w(r/m),b(i) reg=3      spec: 0xC1 mod/reg/rm /3 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCRw %s%s,0x%02lX",IPDecPrint16(mrm,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 4: /* C1h 20h SHLw w(r/m),b(i) reg=4      spec: 0xC1 mod/reg/rm /4 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHLw %s%s,0x%02lX",IPDecPrint16(mrm,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 5: /* C1h 28h SHRw w(r/m),b(i) reg=5      spec: 0xC1 mod/reg/rm /5 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHRw %s%s,0x%02lX",IPDecPrint16(mrm,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 6: /* C1h 30h SALw w(r/m),b(i) reg=6      spec: 0xC1 mod/reg/rm /6 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SALw %s%s,0x%02lX",IPDecPrint16(mrm,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 7: /* C1h 38h SARw w(r/m),b(i) reg=7      spec: 0xC1 mod/reg/rm /7 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SARw %s%s,0x%02lX",IPDecPrint16(mrm,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
