...
/* End of opcodes starting with 0Fh 01h */
            ...
            case 0xB2: /* 0Fh B2h LSSw w(reg),w(r/m)      spec: 0x0F 0xB2 mod/reg/rm */
                IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LSSw %s,%s%s",CPUregsN[2][mrm.reg()],IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                break;
            /* opcode 0Fh B3h  not defined */
            case 0xB4: /* 0Fh B4h LFSw w(reg),w(r/m)      spec: 0x0F 0xB4 mod/reg/rm */
                IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LFSw %s,%s%s",CPUregsN[2][mrm.reg()],IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                break;
            case 0xB5: /* 0Fh B5h LGSw w(reg),w(r/m)      spec: 0x0F 0xB5 mod/reg/rm */
                IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LGSw %s,%s%s",CPUregsN[2][mrm.reg()],IPDecPrint16(mrm,disp,2,RC_REG,"w"));
                break;
            case 0xB6: /* 0Fh B6h MOVZXb w(reg),b(r/m)      spec: 0x0F 0xB6 mod/reg/rm */
                IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVZXb %s,%s%s",CPUregsN[2][mrm.reg()],IPDecPrint16(mrm,disp,1,RC_REG,"b"));
                break;
            case 0xB7: /* 0Fh B7h MOVZXw w(reg),w16(r/m)      spec: 0x0F 0xB7 mod/reg/rm */
                IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVZXw %s,%s%s",CPUregsN[2][mrm.reg()],IPDecPrint16(mrm,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0xBE: /* 0Fh BEh MOVSXb w(reg),b(r/m)      spec: 0x0F 0xBE mod/reg/rm */
                IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVSXb %s,%s%s",CPUregsN[2][mrm.reg()],IPDecPrint16(mrm,disp,1,RC_REG,"b"));
                break;
            case 0xBF: /* 0Fh BFh MOVSXw w(reg),w16(r/m)      spec: 0x0F 0xBF mod/reg/rm */
                IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVSXw %s,%s%s",CPUregsN[2][mrm.reg()],IPDecPrint16(mrm,disp,2,RC_REG,"w16"));
                break;
