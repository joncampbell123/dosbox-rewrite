...
/* End of opcodes starting with 0Fh 26h */
            ...
            case 0xA6: /* 0Fh A6h XBTS w(reg),w(r/m),b(c)      spec: 0x0F 0xA6 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XBTS %s,%s,%s",CPUregsN[4][mrm.reg()],IPDecPrint32(mrm,sib,disp,4,RC_REG,"d"),CPUregsN[1][1]);
                break;
            case 0xA7: /* 0Fh A7h IBTS w(r/m),w(reg),b(c)      spec: 0x0F 0xA7 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IBTS %s,%s,%s",IPDecPrint32(mrm,sib,disp,4,RC_REG,"d"),CPUregsN[4][mrm.reg()],CPUregsN[1][1]);
                break;
