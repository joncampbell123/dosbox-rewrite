...
switch (op=IPFB()) {
    ...
    case 0x01: /* 01h ADDw w(r/m),w(reg)      spec: 0x01 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADDw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
        break;
    ...
    case 0x03: /* 03h ADDw w(reg),w(r/m)      spec: 0x03 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADDw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    ...
    case 0x09: /* 09h ORw w(r/m),w(reg)      spec: 0x09 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ORw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
        break;
    ...
    case 0x0B: /* 0Bh ORw w(reg),w(r/m)      spec: 0x0B mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ORw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
...
/* Opcodes starting with 0Fh 00h */
                switch (mrm.byte) {
                    ...
                    case 0x87: /* 0Fh 00h 87h SLDTw w(r/m) mod=2 reg=0 rm=7      spec: 0x0F 0x00 mod/reg/rm /0 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SLDTw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0x8F: /* 0Fh 00h 8Fh STRw w(r/m) mod=2 reg=1 rm=7      spec: 0x0F 0x00 mod/reg/rm /1 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"STRw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0x97: /* 0Fh 00h 97h LLDTw w(r/m) mod=2 reg=2 rm=7      spec: 0x0F 0x00 mod/reg/rm /2 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LLDTw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0x9F: /* 0Fh 00h 9Fh LTRw w(r/m) mod=2 reg=3 rm=7      spec: 0x0F 0x00 mod/reg/rm /3 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LTRw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0xA7: /* 0Fh 00h A7h VERRw w(r/m) mod=2 reg=4 rm=7      spec: 0x0F 0x00 mod/reg/rm /4 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"VERRw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0xAF: /* 0Fh 00h AFh VERWw w(r/m) mod=2 reg=5 rm=7      spec: 0x0F 0x00 mod/reg/rm /5 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"VERWw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                        break;
...
/* Opcodes starting with 0Fh 01h */
                switch (mrm.byte) {
                    ...
                    case 0x87: /* 0Fh 01h 87h SGDTw w(r/m) mod=2 reg=0 rm=7      spec: 0x0F 0x01 mod/reg/rm /0 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SGDTw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0x8F: /* 0Fh 01h 8Fh SIDTw w(r/m) mod=2 reg=1 rm=7      spec: 0x0F 0x01 mod/reg/rm /1 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SIDTw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0x97: /* 0Fh 01h 97h LGDTw w(r/m) mod=2 reg=2 rm=7      spec: 0x0F 0x01 mod/reg/rm /2 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LGDTw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0x9F: /* 0Fh 01h 9Fh LIDTw w(r/m) mod=2 reg=3 rm=7      spec: 0x0F 0x01 mod/reg/rm /3 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LIDTw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0xA7: /* 0Fh 01h A7h SMSWw w(r/m) mod=2 reg=4 rm=7      spec: 0x0F 0x01 mod/reg/rm /4 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SMSWw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                        break;
                    ...
                    case 0xB7: /* 0Fh 01h B7h LMSWw w(r/m) mod=2 reg=6 rm=7      spec: 0x0F 0x01 mod/reg/rm /6 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LMSWw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                        break;
...
/* End of opcodes starting with 0Fh 01h */
            ...
            case 0x02: /* 0Fh 02h LARw w(reg),w(r/m)      spec: 0x0F 0x02 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LARw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 0x03: /* 0Fh 03h LSLw w(reg),w(r/m)      spec: 0x0F 0x03 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LSLw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            ...
            case 0xB2: /* 0Fh B2h LSSw w(reg),w(r/m)      spec: 0x0F 0xB2 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LSSw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            /* opcode 0Fh B3h  not defined */
            case 0xB4: /* 0Fh B4h LFSw w(reg),w(r/m)      spec: 0x0F 0xB4 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LFSw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 0xB5: /* 0Fh B5h LGSw w(reg),w(r/m)      spec: 0x0F 0xB5 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LGSw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 0xB6: /* 0Fh B6h MOVZXb w(reg),b(r/m)      spec: 0x0F 0xB6 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVZXb %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0xB7: /* 0Fh B7h MOVZXw w(reg),w16(r/m)      spec: 0x0F 0xB7 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVZXw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0xBE: /* 0Fh BEh MOVSXb w(reg),b(r/m)      spec: 0x0F 0xBE mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVSXb %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0xBF: /* 0Fh BFh MOVSXw w(reg),w16(r/m)      spec: 0x0F 0xBF mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVSXw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w16"));
                break;
...
/* End of opcodes starting with 0Fh */
    ...
    case 0x11: /* 11h ADCw w(r/m),w(reg)      spec: 0x11 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADCw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
        break;
    ...
    case 0x13: /* 13h ADCw w(reg),w(r/m)      spec: 0x13 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADCw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    ...
    case 0x19: /* 19h SBBw w(r/m),w(reg)      spec: 0x19 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SBBw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
        break;
    ...
    case 0x1B: /* 1Bh SBBw w(reg),w(r/m)      spec: 0x1B mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SBBw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    ...
    case 0x21: /* 21h ANDw w(r/m),w(reg)      spec: 0x21 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ANDw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
        break;
    ...
    case 0x23: /* 23h ANDw w(reg),w(r/m)      spec: 0x23 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ANDw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    ...
    case 0x26: /* 26h ES:       spec: prefix 0x26 segoverride(es) */
        ...
        goto _x86decode_after_prefix_code16_addr32;
    ...
    case 0x29: /* 29h SUBw w(r/m),w(reg)      spec: 0x29 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUBw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
        break;
    ...
    case 0x2B: /* 2Bh SUBw w(reg),w(r/m)      spec: 0x2B mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUBw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    ...
    case 0x31: /* 31h XORw w(r/m),w(reg)      spec: 0x31 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XORw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
        break;
    ...
    case 0x33: /* 33h XORw w(reg),w(r/m)      spec: 0x33 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XORw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    ...
    case 0x39: /* 39h CMPw w(r/m),w(reg)      spec: 0x39 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
        break;
    ...
    case 0x3B: /* 3Bh CMPw w(reg),w(r/m)      spec: 0x3B mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    ...
    case 0x62: /* 62h BOUNDw w(reg),w(r/m)      spec: 0x62 mod/reg/rm mod!=3 */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"BOUNDw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    case 0x63: /* 63h ARPLw w(r/m),w(reg)      spec: 0x63 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ARPLw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
        break;
    ...
    case 0x69: /* 69h IMULw w(reg),w(r/m),w(i)      spec: 0x69 mod/reg/rm iw */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        imm=IPFcodeW();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IMULw %s,%s,0x%04lX",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
        break;
    ...
    case 0x6B: /* 6Bh IMULb w(reg),w(r/m),b(i)      spec: 0x6B mod/reg/rm ib */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IMULb %s,%s,0x%02lX",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
        break;
...
/* Opcodes starting with 80h */
        switch (mrm.reg()) {
            case 0: /* 80h 00h ADDb b(r/m),i reg=0      spec: 0x80 mod/reg/rm /0 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADDb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 1: /* 80h 08h ORb b(r/m),i reg=1      spec: 0x80 mod/reg/rm /1 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ORb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 2: /* 80h 10h ADCb b(r/m),i reg=2      spec: 0x80 mod/reg/rm /2 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADCb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 3: /* 80h 18h SBBb b(r/m),i reg=3      spec: 0x80 mod/reg/rm /3 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SBBb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 4: /* 80h 20h ANDb b(r/m),i reg=4      spec: 0x80 mod/reg/rm /4 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ANDb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 5: /* 80h 28h SUBb b(r/m),i reg=5      spec: 0x80 mod/reg/rm /5 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUBb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 6: /* 80h 30h XORb b(r/m),i reg=6      spec: 0x80 mod/reg/rm /6 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XORb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 7: /* 80h 38h CMPb b(r/m),i reg=7      spec: 0x80 mod/reg/rm /7 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with 81h */
        switch (mrm.reg()) {
            case 0: /* 81h 00h ADDw w(r/m),i reg=0      spec: 0x81 mod/reg/rm /0 iw */
                imm=IPFcodeW();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADDw %s,0x%04lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 1: /* 81h 08h ORw w(r/m),i reg=1      spec: 0x81 mod/reg/rm /1 iw */
                imm=IPFcodeW();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ORw %s,0x%04lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 2: /* 81h 10h ADCw w(r/m),i reg=2      spec: 0x81 mod/reg/rm /2 iw */
                imm=IPFcodeW();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADCw %s,0x%04lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 3: /* 81h 18h SBBw w(r/m),i reg=3      spec: 0x81 mod/reg/rm /3 iw */
                imm=IPFcodeW();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SBBw %s,0x%04lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 4: /* 81h 20h ANDw w(r/m),i reg=4      spec: 0x81 mod/reg/rm /4 iw */
                imm=IPFcodeW();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ANDw %s,0x%04lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 5: /* 81h 28h SUBw w(r/m),i reg=5      spec: 0x81 mod/reg/rm /5 iw */
                imm=IPFcodeW();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUBw %s,0x%04lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 6: /* 81h 30h XORw w(r/m),i reg=6      spec: 0x81 mod/reg/rm /6 iw */
                imm=IPFcodeW();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XORw %s,0x%04lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 7: /* 81h 38h CMPw w(r/m),i reg=7      spec: 0x81 mod/reg/rm /7 iw */
                imm=IPFcodeW();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPw %s,0x%04lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with 83h */
        switch (mrm.reg()) {
            case 0: /* 83h 00h ADDw w(r/m),i reg=0      spec: 0x83 mod/reg/rm /0 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADDw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 1: /* 83h 08h ORw w(r/m),i reg=1      spec: 0x83 mod/reg/rm /1 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ORw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 2: /* 83h 10h ADCw w(r/m),i reg=2      spec: 0x83 mod/reg/rm /2 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADCw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 3: /* 83h 18h SBBw w(r/m),i reg=3      spec: 0x83 mod/reg/rm /3 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SBBw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 4: /* 83h 20h ANDw w(r/m),i reg=4      spec: 0x83 mod/reg/rm /4 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ANDw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 5: /* 83h 28h SUBw w(r/m),i reg=5      spec: 0x83 mod/reg/rm /5 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUBw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 6: /* 83h 30h XORw w(r/m),i reg=6      spec: 0x83 mod/reg/rm /6 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XORw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 7: /* 83h 38h CMPw w(r/m),i reg=7      spec: 0x83 mod/reg/rm /7 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
/* End of opcodes starting with 83h */
    ...
    case 0x85: /* 85h TESTw w(r/m),w(reg)      spec: 0x85 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"TESTw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
        break;
    ...
    case 0x87: /* 87h XCHGw w(r/m),w(reg)      spec: 0x87 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XCHGw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
        break;
    ...
    case 0x89: /* 89h MOVw w(r/m),w(reg)      spec: 0x89 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
        break;
    ...
    case 0x8B: /* 8Bh MOVw w(reg),w(r/m)      spec: 0x8B mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    case 0x8C: /* 8Ch MOVw w(r/m),seg(reg)      spec: 0x8C mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUsregs_80386[mrm.reg()]);
        break;
    case 0x8D: /* 8Dh LEAw w(reg),w(r/m)      spec: 0x8D mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LEAw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    case 0x8E: /* 8Eh MOVw seg(reg),w(r/m)      spec: 0x8E mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVw %s,%s",CPUsregs_80386[mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    case 0x8F: /* 8Fh POPw w(r/m)      spec: 0x8F mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"POPw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    ...
    case 0xA1: /* A1h MOVw w(a),w(mem[i])      spec: 0xA1 iwa */
        imm=IPFaddrW();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVw %s,[0x%08lX]w",CPUregsN[2][0],(unsigned long)((uint32_t)imm));
        break;
    ...
    case 0xA3: /* A3h MOVw b(mem[i]),w(a)      spec: 0xA3 iwa */
        imm=IPFaddrW();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVw [0x%08lX]b,%s",(unsigned long)((uint32_t)imm),CPUregsN[2][0]);
        break;
...
/* Opcodes starting with C0h */
        switch (mrm.reg()) {
            case 0: /* C0h 00h ROLb b(r/m),b(i) reg=0      spec: 0xC0 mod/reg/rm /0 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROLb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 1: /* C0h 08h RORb b(r/m),b(i) reg=1      spec: 0xC0 mod/reg/rm /1 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RORb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 2: /* C0h 10h RCLb b(r/m),b(i) reg=2      spec: 0xC0 mod/reg/rm /2 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCLb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 3: /* C0h 18h RCRb b(r/m),b(i) reg=3      spec: 0xC0 mod/reg/rm /3 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCRb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 4: /* C0h 20h SHLb b(r/m),b(i) reg=4      spec: 0xC0 mod/reg/rm /4 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHLb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 5: /* C0h 28h SHRb b(r/m),b(i) reg=5      spec: 0xC0 mod/reg/rm /5 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHRb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 6: /* C0h 30h SALb b(r/m),b(i) reg=6      spec: 0xC0 mod/reg/rm /6 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SALb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            case 7: /* C0h 38h SARb b(r/m),b(i) reg=7      spec: 0xC0 mod/reg/rm /7 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SARb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with C1h */
        switch (mrm.reg()) {
            case 0: /* C1h 00h ROLw w(r/m),b(i) reg=0      spec: 0xC1 mod/reg/rm /0 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROLw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 1: /* C1h 08h RORw w(r/m),b(i) reg=1      spec: 0xC1 mod/reg/rm /1 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RORw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 2: /* C1h 10h RCLw w(r/m),b(i) reg=2      spec: 0xC1 mod/reg/rm /2 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCLw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 3: /* C1h 18h RCRw w(r/m),b(i) reg=3      spec: 0xC1 mod/reg/rm /3 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCRw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 4: /* C1h 20h SHLw w(r/m),b(i) reg=4      spec: 0xC1 mod/reg/rm /4 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHLw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 5: /* C1h 28h SHRw w(r/m),b(i) reg=5      spec: 0xC1 mod/reg/rm /5 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHRw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 6: /* C1h 30h SALw w(r/m),b(i) reg=6      spec: 0xC1 mod/reg/rm /6 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SALw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 7: /* C1h 38h SARw w(r/m),b(i) reg=7      spec: 0xC1 mod/reg/rm /7 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SARw %s,0x%02lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
/* End of opcodes starting with C1h */
    ...
    case 0xC4: /* C4h LESw w(reg),w(r/m)      spec: 0xC4 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LESw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    case 0xC5: /* C5h LDSw w(reg),w(r/m)      spec: 0xC5 mod/reg/rm */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LDSw %s,%s",CPUregsN[2][mrm.reg()],IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
        break;
    case 0xC6: /* C6h        spec:  */
        IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
/* Opcodes starting with C6h */
        switch (mrm.reg()) {
            case 0: /* C6h 00h MOVb b(r/m),i reg=0      spec: 0xC6 mod/reg/rm /0 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
            /* reg 1 not defined */
            /* reg 2 not defined */
            /* reg 3 not defined */
...
/* Opcodes starting with C7h */
        switch (mrm.reg()) {
            case 0: /* C7h 00h MOVw w(r/m),i reg=0      spec: 0xC7 mod/reg/rm /0 iw */
                imm=IPFcodeW();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVw %s,0x%04lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            /* reg 1 not defined */
            /* reg 2 not defined */
            /* reg 3 not defined */
...
/* Opcodes starting with D1h */
        switch (mrm.reg()) {
            case 0: /* D1h 00h ROLw w(r/m),1 reg=0      spec: 0xD1 mod/reg/rm /0 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROLw %s,1",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 1: /* D1h 08h RORw w(r/m),1 reg=1      spec: 0xD1 mod/reg/rm /1 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RORw %s,1",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 2: /* D1h 10h RCLw w(r/m),1 reg=2      spec: 0xD1 mod/reg/rm /2 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCLw %s,1",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 3: /* D1h 18h RCRw w(r/m),1 reg=3      spec: 0xD1 mod/reg/rm /3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCRw %s,1",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 4: /* D1h 20h SHLw w(r/m),1 reg=4      spec: 0xD1 mod/reg/rm /4 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHLw %s,1",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 5: /* D1h 28h SHRw w(r/m),1 reg=5      spec: 0xD1 mod/reg/rm /5 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHRw %s,1",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 6: /* D1h 30h SALw w(r/m),1 reg=6      spec: 0xD1 mod/reg/rm /6 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SALw %s,1",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 7: /* D1h 38h SARw w(r/m),1 reg=7      spec: 0xD1 mod/reg/rm /7 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SARw %s,1",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with D3h */
        switch (mrm.reg()) {
            case 0: /* D3h 00h ROLw w(r/m),b(c) reg=0      spec: 0xD3 mod/reg/rm /0 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROLw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[1][1]);
                break;
            case 1: /* D3h 08h RORw w(r/m),b(c) reg=1      spec: 0xD3 mod/reg/rm /1 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RORw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[1][1]);
                break;
            case 2: /* D3h 10h RCLw w(r/m),b(c) reg=2      spec: 0xD3 mod/reg/rm /2 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCLw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[1][1]);
                break;
            case 3: /* D3h 18h RCRw w(r/m),b(c) reg=3      spec: 0xD3 mod/reg/rm /3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCRw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[1][1]);
                break;
            case 4: /* D3h 20h SHLw w(r/m),b(c) reg=4      spec: 0xD3 mod/reg/rm /4 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHLw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[1][1]);
                break;
            case 5: /* D3h 28h SHRw w(r/m),b(c) reg=5      spec: 0xD3 mod/reg/rm /5 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHRw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[1][1]);
                break;
            case 6: /* D3h 30h SALw w(r/m),b(c) reg=6      spec: 0xD3 mod/reg/rm /6 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SALw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[1][1]);
                break;
            case 7: /* D3h 38h SARw w(r/m),b(c) reg=7      spec: 0xD3 mod/reg/rm /7 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SARw %s,%s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),CPUregsN[1][1]);
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with D9h */
        switch (mrm.byte) {
            ...
            case 0xA7: /* D9h A7h FLDENV fenv(r/m) mod=2 reg=4 rm=7      spec: 0xD9 mod/reg/rm /4 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FLDENV %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            ...
            case 0xB7: /* D9h B7h FSTENV fenv(r/m) mod=2 reg=6 rm=7      spec: 0xD9 mod/reg/rm /6 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTENV %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            ...
            case 0x3A: /* D9h 3Ah FSTCWw w16(r/m) mod=0 reg=7 rm=2      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0x3B: /* D9h 3Bh FSTCWw w16(r/m) mod=0 reg=7 rm=3      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0x3C: /* D9h 3Ch FSTCWw w16(r/m) mod=0 reg=7 rm=4      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0x3D: /* D9h 3Dh FSTCWw w16(r/m) mod=0 reg=7 rm=5      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0x3E: /* D9h 3Eh FSTCWw w16(r/m) mod=0 reg=7 rm=6      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0x3F: /* D9h 3Fh FSTCWw w16(r/m) mod=0 reg=7 rm=7      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0x78: /* D9h 78h FSTCWw w16(r/m) mod=1 reg=7 rm=0      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0x79: /* D9h 79h FSTCWw w16(r/m) mod=1 reg=7 rm=1      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0x7A: /* D9h 7Ah FSTCWw w16(r/m) mod=1 reg=7 rm=2      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0x7B: /* D9h 7Bh FSTCWw w16(r/m) mod=1 reg=7 rm=3      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0x7C: /* D9h 7Ch FSTCWw w16(r/m) mod=1 reg=7 rm=4      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0x7D: /* D9h 7Dh FSTCWw w16(r/m) mod=1 reg=7 rm=5      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0x7E: /* D9h 7Eh FSTCWw w16(r/m) mod=1 reg=7 rm=6      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0x7F: /* D9h 7Fh FSTCWw w16(r/m) mod=1 reg=7 rm=7      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0xB8: /* D9h B8h FSTCWw w16(r/m) mod=2 reg=7 rm=0      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0xB9: /* D9h B9h FSTCWw w16(r/m) mod=2 reg=7 rm=1      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0xBA: /* D9h BAh FSTCWw w16(r/m) mod=2 reg=7 rm=2      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0xBB: /* D9h BBh FSTCWw w16(r/m) mod=2 reg=7 rm=3      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            case 0xBC: /* D9h BCh FSTCWw w16(r/m) mod=2 reg=7 rm=4      spec: 0xD9 mod/reg/rm /7 mod!=3 */
            ...
            case 0xBF: /* D9h BFh FSTCWw w16(r/m) mod=2 reg=7 rm=7      spec: 0xD9 mod/reg/rm /7 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTCWw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w16"));
                break;
...
/* Opcodes starting with DDh */
        switch (mrm.byte) {
            ...
            case 0xA7: /* DDh A7h FRSTOR fstate(r/m) mod=2 reg=4 rm=7      spec: 0xDD mod/reg/rm /4 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FRSTOR %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            ...
            case 0xB7: /* DDh B7h FSAVE fstate(r/m) mod=2 reg=6 rm=7      spec: 0xDD mod/reg/rm /6 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSAVE %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
...
/* Opcodes starting with F6h */
        switch (mrm.reg()) {
            ...
            case 1: /* F6h 08h TESTb b(r/m),i reg=1      spec: 0xF6 mod/reg/rm /1 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"TESTb %s,0x%02lX",IPDecPrint32(mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint16_t)imm));
                break;
...
/* Opcodes starting with F7h */
        switch (mrm.reg()) {
            ...
            case 1: /* F7h 08h TESTw w(r/m),i reg=1      spec: 0xF7 mod/reg/rm /1 iw */
                imm=IPFcodeW();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"TESTw %s,0x%04lX",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"),(unsigned long)((uint16_t)imm));
                break;
            case 2: /* F7h 10h NOTw w(r/m) reg=2      spec: 0xF7 mod/reg/rm /2 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"NOTw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 3: /* F7h 18h NEGw w(r/m) reg=3      spec: 0xF7 mod/reg/rm /3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"NEGw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 4: /* F7h 20h MULw w(r/m) reg=4      spec: 0xF7 mod/reg/rm /4 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MULw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 5: /* F7h 28h IMULw w(r/m) reg=5      spec: 0xF7 mod/reg/rm /5 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IMULw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 6: /* F7h 30h DIVw w(r/m) reg=6      spec: 0xF7 mod/reg/rm /6 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"DIVw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 7: /* F7h 38h IDIVw w(r/m) reg=7      spec: 0xF7 mod/reg/rm /7 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IDIVw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with FFh */
        switch (mrm.reg()) {
            case 0: /* FFh 00h INCw w(r/m) reg=0      spec: 0xFF mod/reg/rm /0 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"INCw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 1: /* FFh 08h DECw w(r/m) reg=1      spec: 0xFF mod/reg/rm /1 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"DECw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 2: /* FFh 10h CALLw w(r/m) reg=2      spec: 0xFF mod/reg/rm /2 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CALLw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 3: /* FFh 18h CALLFw w(r/m) reg=3      spec: 0xFF mod/reg/rm /3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CALLFw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 4: /* FFh 20h JMPw w(r/m) reg=4      spec: 0xFF mod/reg/rm /4 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JMPw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 5: /* FFh 28h JMPFw w(r/m) reg=5      spec: 0xFF mod/reg/rm /5 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JMPFw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            case 6: /* FFh 30h PUSHw w(r/m) reg=6      spec: 0xFF mod/reg/rm /6 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUSHw %s",IPDecPrint32(mrm,sib,disp,2,RC_REG,"w"));
                break;
            /* reg 7 not defined */
            default:
                goto _x86decode_illegal_opcode;
