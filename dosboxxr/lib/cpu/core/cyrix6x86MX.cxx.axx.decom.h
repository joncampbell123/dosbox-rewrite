#define IPFcodeW() (code32 ? IPFDW() : IPFW())
#define IPFcodeWsigned() (code32 ? IPFDWsigned() : IPFWsigned())
#define IPFaddrW() (addr32 ? IPFDW() : IPFW())
#define IPFaddrWsigned() (addr32 ? IPFDWsigned() : IPFWsigned())
...
switch (op=IPFB()) {
    case 0x00: /* 00h ADDb b(r/m),b(reg)      spec: 0x00 mod/reg/rm */
        ...
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADDb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
        break;
    case 0x01: /* 01h ADDd w(r/m),w(reg)      spec: 0x01 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADD%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
        break;
    case 0x02: /* 02h ADDb b(reg),b(r/m)      spec: 0x02 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADDb %s,%s",CPUregsN[1][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
        break;
    case 0x03: /* 03h ADDd w(reg),w(r/m)      spec: 0x03 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADD%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    case 0x04: /* 04h ADDb b(a),i      spec: 0x04 ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADDb %s,0x%02lX",CPUregsN[1][0],(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    ...
    case 0x07: /* 07h POPd w(es)      spec: 0x07 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"POP%s %s",code32?"d":"w",CPUsregs_80386[0]);
        break;
    case 0x08: /* 08h ORb b(r/m),b(reg)      spec: 0x08 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ORb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
        break;
    case 0x09: /* 09h ORd w(r/m),w(reg)      spec: 0x09 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"OR%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
        break;
    case 0x0A: /* 0Ah ORb b(reg),b(r/m)      spec: 0x0A mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ORb %s,%s",CPUregsN[1][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
        break;
    case 0x0B: /* 0Bh ORd w(reg),w(r/m)      spec: 0x0B mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"OR%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    case 0x0C: /* 0Ch ORb b(a),i      spec: 0x0C ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ORb %s,0x%02lX",CPUregsN[1][0],(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
...
/* Opcodes starting with 0Fh 00h */
                switch (mrm.byte) {
                    ...
                    case 0x87: /* 0Fh 00h 87h SLDTd w(r/m) mod=2 reg=0 rm=7      spec: 0x0F 0x00 mod/reg/rm /0 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SLDT%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
                    ...
                    case 0x8F: /* 0Fh 00h 8Fh STRd w(r/m) mod=2 reg=1 rm=7      spec: 0x0F 0x00 mod/reg/rm /1 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"STR%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
                    ...
                    case 0x97: /* 0Fh 00h 97h LLDTd w(r/m) mod=2 reg=2 rm=7      spec: 0x0F 0x00 mod/reg/rm /2 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LLDT%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
                    ...
                    case 0x9F: /* 0Fh 00h 9Fh LTRd w(r/m) mod=2 reg=3 rm=7      spec: 0x0F 0x00 mod/reg/rm /3 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LTR%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
                    ...
                    case 0xA7: /* 0Fh 00h A7h VERRd w(r/m) mod=2 reg=4 rm=7      spec: 0x0F 0x00 mod/reg/rm /4 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"VERR%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
                    ...
                    case 0xAF: /* 0Fh 00h AFh VERWd w(r/m) mod=2 reg=5 rm=7      spec: 0x0F 0x00 mod/reg/rm /5 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"VERW%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
...
/* Opcodes starting with 0Fh 01h */
                switch (mrm.byte) {
                    ...
                    case 0x87: /* 0Fh 01h 87h SGDTd w(r/m) mod=2 reg=0 rm=7      spec: 0x0F 0x01 mod/reg/rm /0 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SGDT%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
                    ...
                    case 0x8F: /* 0Fh 01h 8Fh SIDTd w(r/m) mod=2 reg=1 rm=7      spec: 0x0F 0x01 mod/reg/rm /1 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SIDT%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
                    ...
                    case 0x97: /* 0Fh 01h 97h LGDTd w(r/m) mod=2 reg=2 rm=7      spec: 0x0F 0x01 mod/reg/rm /2 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LGDT%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
                    ...
                    case 0x9F: /* 0Fh 01h 9Fh LIDTd w(r/m) mod=2 reg=3 rm=7      spec: 0x0F 0x01 mod/reg/rm /3 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LIDT%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
                    ...
                    case 0xA7: /* 0Fh 01h A7h SMSWd w(r/m) mod=2 reg=4 rm=7      spec: 0x0F 0x01 mod/reg/rm /4 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SMSW%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
                    ...
                    case 0xB7: /* 0Fh 01h B7h LMSWd w(r/m) mod=2 reg=6 rm=7      spec: 0x0F 0x01 mod/reg/rm /6 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LMSW%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
                    ...
                    case 0xBF: /* 0Fh 01h BFh INVLPG b(r/m) mod=2 reg=7 rm=7      spec: 0x0F 0x01 mod/reg/rm mod!=3 /7 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"INVLPG %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                        break;
...
/* End of opcodes starting with 0Fh 01h */
            ...
            case 0x02: /* 0Fh 02h LARd w(reg),w(r/m)      spec: 0x0F 0x02 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LAR%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x03: /* 0Fh 03h LSLd w(reg),w(r/m)      spec: 0x0F 0x03 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LSL%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            /* opcode 0Fh 04h  not defined */
            /* opcode 0Fh 05h  not defined */
            case 0x06: /* 0Fh 06h CLTSd       spec: 0x0F 0x06 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CLTS%s",code32?"d":"w");
                break;
...
/* End of opcodes starting with 0Fh 23h */
            ...
            case 0x50: /* 0Fh 50h PAVEB mmx(reg),mmx(r/m)      spec: 0x0F 0x50 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PAVEB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x51: /* 0Fh 51h PADDSIW mmx(reg),mmx(r/m)      spec: 0x0F 0x51 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PADDSIW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x52: /* 0Fh 52h PMAGW mmx(reg),mmx(r/m)      spec: 0x0F 0x52 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMAGW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0x54: /* 0Fh 54h PDISTIB mmx(reg),mmx(r/m)      spec: 0x0F 0x54 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PDISTIB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x55: /* 0Fh 55h PSUBSIW mmx(reg),mmx(r/m)      spec: 0x0F 0x55 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSUBSIW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0x58: /* 0Fh 58h PMVZB mmx(reg),mmx(r/m)      spec: 0x0F 0x58 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMVZB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x59: /* 0Fh 59h PMULHRW mmx(reg),mmx(r/m)      spec: 0x0F 0x59 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMULHRW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x5A: /* 0Fh 5Ah PMVNZB mmx(reg),mmx(r/m)      spec: 0x0F 0x5A mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMVNZB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x5B: /* 0Fh 5Bh PMVLZB mmx(reg),mmx(r/m)      spec: 0x0F 0x5B mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMVLZB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x5C: /* 0Fh 5Ch PMVGEZB mmx(reg),mmx(r/m)      spec: 0x0F 0x5C mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMVGEZB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x5D: /* 0Fh 5Dh PMULHRIW mmx(reg),mmx(r/m)      spec: 0x0F 0x5D mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMULHRIW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
...
/* Opcodes starting with 0Fh 5Eh */
                switch (mrm.byte) {
                    ...
                    case 0xBF: /* 0Fh 5Eh BFh PMACHRIW mmx(reg),mmx(r/m) mod=2 reg=7 rm=7      spec: 0x0F 0x5E mod/reg/rm mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMACHRIW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
...
/* End of opcodes starting with 0Fh 5Eh */
            ...
            case 0x60: /* 0Fh 60h PUNPCKLBW mmx(reg),mmx(r/m)      spec: 0x0F 0x60 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUNPCKLBW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x61: /* 0Fh 61h PUNPCKLWD mmx(reg),mmx(r/m)      spec: 0x0F 0x61 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUNPCKLWD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x62: /* 0Fh 62h PUNPCKLWQ mmx(reg),mmx(r/m)      spec: 0x0F 0x62 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUNPCKLWQ MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x63: /* 0Fh 63h PACKSSWB mmx(reg),mmx(r/m)      spec: 0x0F 0x63 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PACKSSWB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x64: /* 0Fh 64h PCMPGTB mmx(reg),mmx(r/m)      spec: 0x0F 0x64 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PCMPGTB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x65: /* 0Fh 65h PCMPGTW mmx(reg),mmx(r/m)      spec: 0x0F 0x65 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PCMPGTW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x66: /* 0Fh 66h PCMPGTD mmx(reg),mmx(r/m)      spec: 0x0F 0x66 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PCMPGTD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x67: /* 0Fh 67h PACKUSWB mmx(reg),mmx(r/m)      spec: 0x0F 0x67 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PACKUSWB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x68: /* 0Fh 68h PUNPCKHBW mmx(reg),mmx(r/m)      spec: 0x0F 0x68 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUNPCKHBW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x69: /* 0Fh 69h PUNPCKHWD mmx(reg),mmx(r/m)      spec: 0x0F 0x69 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUNPCKHWD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x6A: /* 0Fh 6Ah PUNPCKHDQ mmx(reg),mmx(r/m)      spec: 0x0F 0x6A mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUNPCKHDQ MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x6B: /* 0Fh 6Bh PACKSSDW mmx(reg),mmx(r/m)      spec: 0x0F 0x6B mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PACKSSDW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0x6E: /* 0Fh 6Eh MOVD mmx(reg),w32(r/m)      spec: 0x0F 0x6E mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"));
                break;
            case 0x6F: /* 0Fh 6Fh MOVQ mmx(reg),mmx(r/m)      spec: 0x0F 0x6F mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVQ MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
...
/* Opcodes starting with 0Fh 71h */
                switch (mrm.reg()) {
                    ...
                    case 2: /* 0Fh 71h 10h PSRLW mmx(r/m),i reg=2      spec: 0x0F 0x71 mod/reg/rm /2 ib */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSRLW %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    /* reg 3 not defined */
                    case 4: /* 0Fh 71h 20h PSRAW mmx(r/m),i reg=4      spec: 0x0F 0x71 mod/reg/rm /4 ib */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSRAW %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    /* reg 5 not defined */
                    case 6: /* 0Fh 71h 30h PSLLW mmx(r/m),i reg=6      spec: 0x0F 0x71 mod/reg/rm /6 ib */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSLLW %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    /* reg 7 not defined */
                    default:
                        goto _x86decode_illegal_opcode;
...
/* Opcodes starting with 0Fh 72h */
                switch (mrm.reg()) {
                    ...
                    case 2: /* 0Fh 72h 10h PSRLD mmx(r/m),i reg=2      spec: 0x0F 0x72 mod/reg/rm /2 ib */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSRLD %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    /* reg 3 not defined */
                    case 4: /* 0Fh 72h 20h PSRAD mmx(r/m),i reg=4      spec: 0x0F 0x72 mod/reg/rm /4 ib */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSRAD %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    /* reg 5 not defined */
                    case 6: /* 0Fh 72h 30h PSLLD mmx(r/m),i reg=6      spec: 0x0F 0x72 mod/reg/rm /6 ib */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSLLD %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    /* reg 7 not defined */
                    default:
                        goto _x86decode_illegal_opcode;
...
/* Opcodes starting with 0Fh 73h */
                switch (mrm.reg()) {
                    ...
                    case 2: /* 0Fh 73h 10h PSRLQ mmx(r/m),i reg=2      spec: 0x0F 0x73 mod/reg/rm /2 ib */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSRLQ %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    /* reg 3 not defined */
                    /* reg 4 not defined */
                    /* reg 5 not defined */
                    case 6: /* 0Fh 73h 30h PSLLQ mmx(r/m),i reg=6      spec: 0x0F 0x73 mod/reg/rm /6 ib */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSLLQ %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    /* reg 7 not defined */
                    default:
                        goto _x86decode_illegal_opcode;
...
/* End of opcodes starting with 0Fh 73h */
            ...
            case 0x74: /* 0Fh 74h PCMPEQB mmx(reg),mmx(r/m)      spec: 0x0F 0x74 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PCMPEQB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x75: /* 0Fh 75h PCMPEQW mmx(reg),mmx(r/m)      spec: 0x0F 0x75 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PCMPEQW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x76: /* 0Fh 76h PCMPEQD mmx(reg),mmx(r/m)      spec: 0x0F 0x76 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PCMPEQD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0x7E: /* 0Fh 7Eh MOVD w32(r/m),mmx(reg)      spec: 0x0F 0x7E mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVD %s,MM%u",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"),mrm.reg());
                break;
            case 0x7F: /* 0Fh 7Fh MOVQ mmx(r/m),mmx(reg)      spec: 0x0F 0x7F mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVQ %s,MM%u",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""),mrm.reg());
                break;
            ...
            case 0x90: /* 0Fh 90h SETO b(r/m)      spec: 0x0F 0x90 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETO %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x91: /* 0Fh 91h SETNO b(r/m)      spec: 0x0F 0x91 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETNO %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x92: /* 0Fh 92h SETB b(r/m)      spec: 0x0F 0x92 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETB %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x93: /* 0Fh 93h SETNB b(r/m)      spec: 0x0F 0x93 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETNB %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x94: /* 0Fh 94h SETZ b(r/m)      spec: 0x0F 0x94 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETZ %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x95: /* 0Fh 95h SETNZ b(r/m)      spec: 0x0F 0x95 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETNZ %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x96: /* 0Fh 96h SETBE b(r/m)      spec: 0x0F 0x96 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETBE %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x97: /* 0Fh 97h SETA b(r/m)      spec: 0x0F 0x97 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETA %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x98: /* 0Fh 98h SETS b(r/m)      spec: 0x0F 0x98 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETS %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x99: /* 0Fh 99h SETNS b(r/m)      spec: 0x0F 0x99 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETNS %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x9A: /* 0Fh 9Ah SETPE b(r/m)      spec: 0x0F 0x9A mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETPE %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x9B: /* 0Fh 9Bh SETPO b(r/m)      spec: 0x0F 0x9B mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETPO %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x9C: /* 0Fh 9Ch SETL b(r/m)      spec: 0x0F 0x9C mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETL %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x9D: /* 0Fh 9Dh SETGE b(r/m)      spec: 0x0F 0x9D mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETGE %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x9E: /* 0Fh 9Eh SETLE b(r/m)      spec: 0x0F 0x9E mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETLE %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x9F: /* 0Fh 9Fh SETG b(r/m)      spec: 0x0F 0x9F mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SETG %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0xA0: /* 0Fh A0h PUSHd w(fs)      spec: 0x0F 0xA0 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUSH%s %s",code32?"d":"w",CPUsregs_80386[4]);
                break;
            case 0xA1: /* 0Fh A1h POPd w(fs)      spec: 0x0F 0xA1 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"POP%s %s",code32?"d":"w",CPUsregs_80386[4]);
                break;
            ...
            case 0xA8: /* 0Fh A8h PUSHd w(gs)      spec: 0x0F 0xA8 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUSH%s %s",code32?"d":"w",CPUsregs_80386[5]);
                break;
            ...
            case 0xAF: /* 0Fh AFh IMULd w(reg),w(r/m)      spec: 0x0F 0xAF mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IMUL%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0xB0: /* 0Fh B0h CMPXCHGb b(r/m),b(reg)      spec: 0x0F 0xB0 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPXCHGb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
                break;
            case 0xB1: /* 0Fh B1h CMPXCHGd w(r/m),w(reg)      spec: 0x0F 0xB1 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPXCHG%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
                break;
            case 0xB2: /* 0Fh B2h LSSd w(reg),w(r/m)      spec: 0x0F 0xB2 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LSS%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0xB3: /* 0Fh B3h BTRd w(r/m),w(reg)      spec: 0x0F 0xB3 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"BTR%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
                break;
            case 0xB4: /* 0Fh B4h LFSd w(reg),w(r/m)      spec: 0x0F 0xB4 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LFS%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0xB5: /* 0Fh B5h LGSd w(reg),w(r/m)      spec: 0x0F 0xB5 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LGS%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0xB6: /* 0Fh B6h MOVZXb w(reg),b(r/m)      spec: 0x0F 0xB6 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVZXb %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
...
/* Opcodes starting with 0Fh BAh */
                switch (mrm.reg()) {
                    ...
                    case 4: /* 0Fh BAh 20h BTd w(r/m),i reg=4      spec: 0x0F 0xBA mod/reg/rm /4 ib */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"BT%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    case 5: /* 0Fh BAh 28h BTSd w(r/m),i reg=5      spec: 0x0F 0xBA mod/reg/rm /5 ib */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"BTS%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    case 6: /* 0Fh BAh 30h BTRd w(r/m),i reg=6      spec: 0x0F 0xBA mod/reg/rm /6 ib */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"BTR%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    case 7: /* 0Fh BAh 38h BTCd w(r/m),i reg=7      spec: 0x0F 0xBA mod/reg/rm /7 ib */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"BTC%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    default:
                        goto _x86decode_illegal_opcode;
                };
/* End of opcodes starting with 0Fh BAh */
            ...
            case 0xBB: /* 0Fh BBh BTCd w(r/m),w(reg)      spec: 0x0F 0xBB mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"BTC%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
                break;
            case 0xBC: /* 0Fh BCh BSFd w(reg),w(r/m)      spec: 0x0F 0xBC mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"BSF%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0xBD: /* 0Fh BDh BSRd w(reg),w(r/m)      spec: 0x0F 0xBD mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"BSR%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0xBE: /* 0Fh BEh MOVSXb w(reg),b(r/m)      spec: 0x0F 0xBE mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVSXb %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0xBF: /* 0Fh BFh MOVSXd w(reg),w16(r/m)      spec: 0x0F 0xBF mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVSX%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            case 0xC0: /* 0Fh C0h XADDb b(r/m),b(reg)      spec: 0x0F 0xC0 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XADDb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
                break;
            case 0xC1: /* 0Fh C1h XADDd w(r/m),w(reg)      spec: 0x0F 0xC1 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XADD%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
                break;
...
/* Opcodes starting with 0Fh C7h */
                switch (mrm.byte) {
                    ...
                    case 0x8F: /* 0Fh C7h 8Fh CMPXCHG8Bb b(r/m) mod=2 reg=1 rm=7      spec: 0x0F 0xC7 mod/reg/rm /1 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPXCHG8Bb %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                        break;
...
/* End of opcodes starting with 0Fh C7h */
            ...
            case 0xCF: /* 0Fh CFh BSWAPd w(reg) reg=7      spec: 0x0F range(0xC8,0xCF) reg=op02 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"BSWAP%s %s",code32?"d":"w",CPUregsN[code32?4:2][op&7]);
                break;
            ...
            case 0xD1: /* 0Fh D1h PSRLW mmx(reg),mmx(r/m)      spec: 0x0F 0xD1 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSRLW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xD2: /* 0Fh D2h PSRLD mmx(reg),mmx(r/m)      spec: 0x0F 0xD2 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSRLD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xD3: /* 0Fh D3h PSRLQ mmx(reg),mmx(r/m)      spec: 0x0F 0xD3 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSRLQ MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xD4: /* 0Fh D4h PADDQ mmx(reg),mmx(r/m)      spec: 0x0F 0xD4 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PADDQ MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xD5: /* 0Fh D5h PMULLW mmx(reg),mmx(r/m)      spec: 0x0F 0xD5 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMULLW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xD8: /* 0Fh D8h PSUBUSB mmx(reg),mmx(r/m)      spec: 0x0F 0xD8 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSUBUSB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xD9: /* 0Fh D9h PSUBUSW mmx(reg),mmx(r/m)      spec: 0x0F 0xD9 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSUBUSW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xDB: /* 0Fh DBh PAND mmx(reg),mmx(r/m)      spec: 0x0F 0xDB mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PAND MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xDC: /* 0Fh DCh PADDUSB mmx(reg),mmx(r/m)      spec: 0x0F 0xDC mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PADDUSB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xDD: /* 0Fh DDh PADDUSW mmx(reg),mmx(r/m)      spec: 0x0F 0xDD mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PADDUSW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xDF: /* 0Fh DFh PANDN mmx(reg),mmx(r/m)      spec: 0x0F 0xDF mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PANDN MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xE1: /* 0Fh E1h PSRAW mmx(reg),mmx(r/m)      spec: 0x0F 0xE1 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSRAW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xE2: /* 0Fh E2h PSRAD mmx(reg),mmx(r/m)      spec: 0x0F 0xE2 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSRAD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xE5: /* 0Fh E5h PMULHW mmx(reg),mmx(r/m)      spec: 0x0F 0xE5 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMULHW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xE8: /* 0Fh E8h PSUBSB mmx(reg),mmx(r/m)      spec: 0x0F 0xE8 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSUBSB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xE9: /* 0Fh E9h PSUBSW mmx(reg),mmx(r/m)      spec: 0x0F 0xE9 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSUBSW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xEB: /* 0Fh EBh POR mmx(reg),mmx(r/m)      spec: 0x0F 0xEB mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"POR MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xEC: /* 0Fh ECh PADDSB mmx(reg),mmx(r/m)      spec: 0x0F 0xEC mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PADDSB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xED: /* 0Fh EDh PADDSW mmx(reg),mmx(r/m)      spec: 0x0F 0xED mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PADDSW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xEF: /* 0Fh EFh PXOR mmx(reg),mmx(r/m)      spec: 0x0F 0xEF mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PXOR MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xF1: /* 0Fh F1h PSLLW mmx(reg),mmx(r/m)      spec: 0x0F 0xF1 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSLLW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xF2: /* 0Fh F2h PSLLD mmx(reg),mmx(r/m)      spec: 0x0F 0xF2 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSLLD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xF3: /* 0Fh F3h PSLLQ mmx(reg),mmx(r/m)      spec: 0x0F 0xF3 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSLLQ MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xF5: /* 0Fh F5h PMADDWD mmx(reg),mmx(r/m)      spec: 0x0F 0xF5 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMADDWD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xF8: /* 0Fh F8h PSUBB mmx(reg),mmx(r/m)      spec: 0x0F 0xF8 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSUBB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xF9: /* 0Fh F9h PSUBW mmx(reg),mmx(r/m)      spec: 0x0F 0xF9 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSUBW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xFA: /* 0Fh FAh PSUBD mmx(reg),mmx(r/m)      spec: 0x0F 0xFA mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSUBD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xFC: /* 0Fh FCh PADDB mmx(reg),mmx(r/m)      spec: 0x0F 0xFC mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PADDB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xFD: /* 0Fh FDh PADDW mmx(reg),mmx(r/m)      spec: 0x0F 0xFD mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PADDW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xFE: /* 0Fh FEh PADDD mmx(reg),mmx(r/m)      spec: 0x0F 0xFE mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PADDD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
...
/* End of opcodes starting with 0Fh */
    ...
    case 0x10: /* 10h ADCb b(r/m),b(reg)      spec: 0x10 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADCb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
        break;
    case 0x11: /* 11h ADCd w(r/m),w(reg)      spec: 0x11 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADC%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
        break;
    case 0x12: /* 12h ADCb b(reg),b(r/m)      spec: 0x12 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADCb %s,%s",CPUregsN[1][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
        break;
    case 0x13: /* 13h ADCd w(reg),w(r/m)      spec: 0x13 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADC%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    case 0x14: /* 14h ADCb b(a),i      spec: 0x14 ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADCb %s,0x%02lX",CPUregsN[1][0],(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    ...
    case 0x17: /* 17h POPd w(ss)      spec: 0x17 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"POP%s %s",code32?"d":"w",CPUsregs_80386[2]);
        break;
    case 0x18: /* 18h SBBb b(r/m),b(reg)      spec: 0x18 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SBBb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
        break;
    case 0x19: /* 19h SBBd w(r/m),w(reg)      spec: 0x19 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SBB%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
        break;
    case 0x1A: /* 1Ah SBBb b(reg),b(r/m)      spec: 0x1A mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SBBb %s,%s",CPUregsN[1][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
        break;
    case 0x1B: /* 1Bh SBBd w(reg),w(r/m)      spec: 0x1B mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SBB%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    case 0x1C: /* 1Ch SBBb b(a),i      spec: 0x1C ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SBBb %s,0x%02lX",CPUregsN[1][0],(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    ...
    case 0x1F: /* 1Fh POPd w(ds)      spec: 0x1F */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"POP%s %s",code32?"d":"w",CPUsregs_80386[3]);
        break;
    case 0x20: /* 20h ANDb b(r/m),b(reg)      spec: 0x20 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ANDb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
        break;
    case 0x21: /* 21h ANDd w(r/m),w(reg)      spec: 0x21 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"AND%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
        break;
    case 0x22: /* 22h ANDb b(reg),b(r/m)      spec: 0x22 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ANDb %s,%s",CPUregsN[1][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
        break;
    case 0x23: /* 23h ANDd w(reg),w(r/m)      spec: 0x23 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"AND%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    case 0x24: /* 24h ANDb b(a),i      spec: 0x24 ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ANDb %s,0x%02lX",CPUregsN[1][0],(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    ...
    case 0x28: /* 28h SUBb b(r/m),b(reg)      spec: 0x28 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUBb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
        break;
    case 0x29: /* 29h SUBd w(r/m),w(reg)      spec: 0x29 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUB%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
        break;
    case 0x2A: /* 2Ah SUBb b(reg),b(r/m)      spec: 0x2A mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUBb %s,%s",CPUregsN[1][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
        break;
    case 0x2B: /* 2Bh SUBd w(reg),w(r/m)      spec: 0x2B mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUB%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    case 0x2C: /* 2Ch SUBb b(a),i      spec: 0x2C ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUBb %s,0x%02lX",CPUregsN[1][0],(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    ...
    case 0x30: /* 30h XORb b(r/m),b(reg)      spec: 0x30 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XORb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
        break;
    case 0x31: /* 31h XORd w(r/m),w(reg)      spec: 0x31 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XOR%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
        break;
    case 0x32: /* 32h XORb b(reg),b(r/m)      spec: 0x32 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XORb %s,%s",CPUregsN[1][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
        break;
    case 0x33: /* 33h XORd w(reg),w(r/m)      spec: 0x33 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XOR%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    case 0x34: /* 34h XORb b(a),i      spec: 0x34 ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XORb %s,0x%02lX",CPUregsN[1][0],(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    ...
    case 0x38: /* 38h CMPb b(r/m),b(reg)      spec: 0x38 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
        break;
    case 0x39: /* 39h CMPd w(r/m),w(reg)      spec: 0x39 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMP%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
        break;
    case 0x3A: /* 3Ah CMPb b(reg),b(r/m)      spec: 0x3A mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPb %s,%s",CPUregsN[1][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
        break;
    case 0x3B: /* 3Bh CMPd w(reg),w(r/m)      spec: 0x3B mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMP%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    case 0x3C: /* 3Ch CMPb b(a),i      spec: 0x3C ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPb %s,0x%02lX",CPUregsN[1][0],(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    ...
    case 0x47: /* 47h INCd w(reg) reg=7      spec: range(0x40,0x47) reg=op02 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"INC%s %s",code32?"d":"w",CPUregsN[code32?4:2][op&7]);
        break;
    ...
    case 0x4F: /* 4Fh DECd w(reg) reg=7      spec: range(0x48,0x4F) reg=op02 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"DEC%s %s",code32?"d":"w",CPUregsN[code32?4:2][op&7]);
        break;
    ...
    case 0x57: /* 57h PUSHd w(reg) reg=7      spec: range(0x50,0x57) reg=op02 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUSH%s %s",code32?"d":"w",CPUregsN[code32?4:2][op&7]);
        break;
    ...
    case 0x5F: /* 5Fh POPd w(reg) reg=7      spec: range(0x58,0x5F) reg=op02 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"POP%s %s",code32?"d":"w",CPUregsN[code32?4:2][op&7]);
        break;
    case 0x60: /* 60h PUSHAd       spec: 0x60 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUSHA%s",code32?"d":"w");
        break;
    case 0x61: /* 61h POPAd       spec: 0x61 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"POPA%s",code32?"d":"w");
        break;
    case 0x62: /* 62h        spec:  */
        if (addr32)
            IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
...
/* Opcodes starting with 62h */
        switch (mrm.byte) {
            ...
            case 0xBF: /* 62h BFh BOUNDd w(reg),w(r/m) mod=2 reg=7 rm=7      spec: 0x62 mod/reg/rm mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"BOUND%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
...
/* End of opcodes starting with 62h */
    ...
    case 0x63: /* 63h ARPLd w(r/m),w(reg)      spec: 0x63 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ARPL%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
        break;
    ...
    case 0x6A: /* 6Ah PUSHd w(i)      spec: 0x6A ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUSH%s 0x%02lX",code32?"d":"w",(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x6B: /* 6Bh IMULb w(reg),w(r/m),b(i)      spec: 0x6B mod/reg/rm ib */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IMULb %s,%s,0x%02lX",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x6C: /* 6Ch INSb       spec: 0x6C */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"INSb");
        break;
    case 0x6D: /* 6Dh INSd       spec: 0x6D */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"INS%s",code32?"d":"w");
        break;
    case 0x6E: /* 6Eh OUTSb       spec: 0x6E */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"OUTSb");
        break;
    case 0x6F: /* 6Fh OUTSd       spec: 0x6F */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"OUTS%s",code32?"d":"w");
        break;
    case 0x70: /* 70h JO w(i+ip)      spec: 0x70 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JO 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x71: /* 71h JNO w(i+ip)      spec: 0x71 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JNO 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x72: /* 72h JB w(i+ip)      spec: 0x72 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JB 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x73: /* 73h JNB w(i+ip)      spec: 0x73 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JNB 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x74: /* 74h JZ w(i+ip)      spec: 0x74 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JZ 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x75: /* 75h JNZ w(i+ip)      spec: 0x75 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JNZ 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x76: /* 76h JBE w(i+ip)      spec: 0x76 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JBE 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x77: /* 77h JA w(i+ip)      spec: 0x77 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JA 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x78: /* 78h JS w(i+ip)      spec: 0x78 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JS 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x79: /* 79h JNS w(i+ip)      spec: 0x79 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JNS 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x7A: /* 7Ah JPE w(i+ip)      spec: 0x7A ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JPE 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x7B: /* 7Bh JPO w(i+ip)      spec: 0x7B ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JPO 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x7C: /* 7Ch JL w(i+ip)      spec: 0x7C ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JL 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x7D: /* 7Dh JGE w(i+ip)      spec: 0x7D ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JGE 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x7E: /* 7Eh JLE w(i+ip)      spec: 0x7E ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JLE 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x7F: /* 7Fh JG w(i+ip)      spec: 0x7F ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JG 0x%02lX",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0x80: /* 80h        spec:  */
    case 0x82: /* 82h        spec:  */
        if (addr32)
...
/* Opcodes starting with 80h */
        switch (mrm.reg()) {
            case 0: /* 80h 00h ADDb b(r/m),i reg=0      spec: 0x80 mod/reg/rm /0 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADDb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 1: /* 80h 08h ORb b(r/m),i reg=1      spec: 0x80 mod/reg/rm /1 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ORb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 2: /* 80h 10h ADCb b(r/m),i reg=2      spec: 0x80 mod/reg/rm /2 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADCb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 3: /* 80h 18h SBBb b(r/m),i reg=3      spec: 0x80 mod/reg/rm /3 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SBBb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 4: /* 80h 20h ANDb b(r/m),i reg=4      spec: 0x80 mod/reg/rm /4 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ANDb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 5: /* 80h 28h SUBb b(r/m),i reg=5      spec: 0x80 mod/reg/rm /5 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUBb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 6: /* 80h 30h XORb b(r/m),i reg=6      spec: 0x80 mod/reg/rm /6 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XORb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 7: /* 80h 38h CMPb b(r/m),i reg=7      spec: 0x80 mod/reg/rm /7 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with 83h */
        switch (mrm.reg()) {
            case 0: /* 83h 00h ADDd w(r/m),i reg=0      spec: 0x83 mod/reg/rm /0 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADD%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 1: /* 83h 08h ORd w(r/m),i reg=1      spec: 0x83 mod/reg/rm /1 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"OR%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 2: /* 83h 10h ADCd w(r/m),i reg=2      spec: 0x83 mod/reg/rm /2 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADC%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 3: /* 83h 18h SBBd w(r/m),i reg=3      spec: 0x83 mod/reg/rm /3 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SBB%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 4: /* 83h 20h ANDd w(r/m),i reg=4      spec: 0x83 mod/reg/rm /4 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"AND%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 5: /* 83h 28h SUBd w(r/m),i reg=5      spec: 0x83 mod/reg/rm /5 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUB%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 6: /* 83h 30h XORd w(r/m),i reg=6      spec: 0x83 mod/reg/rm /6 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XOR%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 7: /* 83h 38h CMPd w(r/m),i reg=7      spec: 0x83 mod/reg/rm /7 ibs */
                imm=IPFBsigned();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMP%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
/* End of opcodes starting with 83h */
    ...
    case 0x84: /* 84h TESTb b(r/m),b(reg)      spec: 0x84 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"TESTb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
        break;
    case 0x85: /* 85h TESTd w(r/m),w(reg)      spec: 0x85 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"TEST%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
        break;
    case 0x86: /* 86h XCHGb b(r/m),b(reg)      spec: 0x86 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XCHGb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
        break;
    case 0x87: /* 87h XCHGd w(r/m),w(reg)      spec: 0x87 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XCHG%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
        break;
    case 0x88: /* 88h MOVb b(r/m),b(reg)      spec: 0x88 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
        break;
    case 0x89: /* 89h MOVd w(r/m),w(reg)      spec: 0x89 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOV%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
        break;
    case 0x8A: /* 8Ah MOVb b(reg),b(r/m)      spec: 0x8A mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVb %s,%s",CPUregsN[1][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
        break;
    case 0x8B: /* 8Bh MOVd w(reg),w(r/m)      spec: 0x8B mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOV%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    case 0x8C: /* 8Ch MOVd w(r/m),seg(reg)      spec: 0x8C mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOV%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUsregs_80386[mrm.reg()]);
        break;
    case 0x8D: /* 8Dh LEAd w(reg),w(r/m)      spec: 0x8D mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LEA%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    case 0x8E: /* 8Eh MOVd seg(reg),w(r/m)      spec: 0x8E mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOV%s %s,%s",code32?"d":"w",CPUsregs_80386[mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    case 0x8F: /* 8Fh POPd w(r/m)      spec: 0x8F mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"POP%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    ...
    case 0x97: /* 97h XCHGd w(reg),w(a) reg=7      spec: range(0x91,0x97) reg=op02 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XCHG%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][op&7],CPUregsN[code32?4:2][0]);
        break;
    case 0x98: /* 98h CBWb       spec: 0x98 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CBWb");
        break;
    case 0x99: /* 99h CWDd       spec: 0x99 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CWD%s",code32?"d":"w");
        break;
    ...
    case 0x9C: /* 9Ch PUSHFd       spec: 0x9C */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUSHF%s",code32?"d":"w");
        break;
    case 0x9D: /* 9Dh POPFd       spec: 0x9D */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"POPF%s",code32?"d":"w");
        break;
    ...
    case 0xA5: /* A5h MOVSd       spec: 0xA5 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVS%s",code32?"d":"w");
        break;
    case 0xA6: /* A6h CMPSb       spec: 0xA6 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPSb");
        break;
    case 0xA7: /* A7h CMPSd       spec: 0xA7 */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPS%s",code32?"d":"w");
        break;
    case 0xA8: /* A8h TESTb b(a),i      spec: 0xA8 ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"TESTb %s,0x%02lX",CPUregsN[1][0],(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    ...
    case 0xB7: /* B7h MOVb b(reg),i reg=7      spec: range(0xB0,0xB7) ib reg=op02 */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVb %s,0x%02lX",CPUregsN[1][op&7],(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
...
/* Opcodes starting with C0h */
        switch (mrm.reg()) {
            case 0: /* C0h 00h ROLb b(r/m),b(i) reg=0      spec: 0xC0 mod/reg/rm /0 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROLb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 1: /* C0h 08h RORb b(r/m),b(i) reg=1      spec: 0xC0 mod/reg/rm /1 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RORb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 2: /* C0h 10h RCLb b(r/m),b(i) reg=2      spec: 0xC0 mod/reg/rm /2 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCLb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 3: /* C0h 18h RCRb b(r/m),b(i) reg=3      spec: 0xC0 mod/reg/rm /3 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCRb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 4: /* C0h 20h SHLb b(r/m),b(i) reg=4      spec: 0xC0 mod/reg/rm /4 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHLb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 5: /* C0h 28h SHRb b(r/m),b(i) reg=5      spec: 0xC0 mod/reg/rm /5 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHRb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 6: /* C0h 30h SALb b(r/m),b(i) reg=6      spec: 0xC0 mod/reg/rm /6 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SALb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 7: /* C0h 38h SARb b(r/m),b(i) reg=7      spec: 0xC0 mod/reg/rm /7 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SARb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with C1h */
        switch (mrm.reg()) {
            case 0: /* C1h 00h ROLd w(r/m),b(i) reg=0      spec: 0xC1 mod/reg/rm /0 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROL%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 1: /* C1h 08h RORd w(r/m),b(i) reg=1      spec: 0xC1 mod/reg/rm /1 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROR%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 2: /* C1h 10h RCLd w(r/m),b(i) reg=2      spec: 0xC1 mod/reg/rm /2 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCL%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 3: /* C1h 18h RCRd w(r/m),b(i) reg=3      spec: 0xC1 mod/reg/rm /3 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCR%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 4: /* C1h 20h SHLd w(r/m),b(i) reg=4      spec: 0xC1 mod/reg/rm /4 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHL%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 5: /* C1h 28h SHRd w(r/m),b(i) reg=5      spec: 0xC1 mod/reg/rm /5 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHR%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 6: /* C1h 30h SALd w(r/m),b(i) reg=6      spec: 0xC1 mod/reg/rm /6 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SAL%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            case 7: /* C1h 38h SARd w(r/m),b(i) reg=7      spec: 0xC1 mod/reg/rm /7 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SAR%s %s,0x%02lX",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
/* End of opcodes starting with C1h */
    ...
    case 0xC4: /* C4h LESd w(reg),w(r/m)      spec: 0xC4 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LES%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    case 0xC5: /* C5h LDSd w(reg),w(r/m)      spec: 0xC5 mod/reg/rm */
        if (addr32)
            ...
            IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LDS%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
        break;
    case 0xC6: /* C6h        spec:  */
        if (addr32)
            IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
...
/* Opcodes starting with C6h */
        switch (mrm.reg()) {
            case 0: /* C6h 00h MOVb b(r/m),i reg=0      spec: 0xC6 mod/reg/rm /0 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            /* reg 1 not defined */
            /* reg 2 not defined */
            /* reg 3 not defined */
...
/* End of opcodes starting with C7h */
    ...
    case 0xCC: /* CCh INT3d       spec: 0xCC */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"INT3%s",code32?"d":"w");
        break;
    case 0xCD: /* CDh INTd i      spec: 0xCD ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"INT%s 0x%02lX",code32?"d":"w",(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0xCE: /* CEh INTOd       spec: 0xCE */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"INTO%s",code32?"d":"w");
        break;
    case 0xCF: /* CFh IRETd       spec: 0xCF */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IRET%s",code32?"d":"w");
        break;
    case 0xD0: /* D0h        spec:  */
        if (addr32)
            IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
...
/* Opcodes starting with D0h */
        switch (mrm.reg()) {
            case 0: /* D0h 00h ROLb b(r/m),1 reg=0      spec: 0xD0 mod/reg/rm /0 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROLb %s,1",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 1: /* D0h 08h RORb b(r/m),1 reg=1      spec: 0xD0 mod/reg/rm /1 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RORb %s,1",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 2: /* D0h 10h RCLb b(r/m),1 reg=2      spec: 0xD0 mod/reg/rm /2 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCLb %s,1",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 3: /* D0h 18h RCRb b(r/m),1 reg=3      spec: 0xD0 mod/reg/rm /3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCRb %s,1",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 4: /* D0h 20h SHLb b(r/m),1 reg=4      spec: 0xD0 mod/reg/rm /4 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHLb %s,1",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 5: /* D0h 28h SHRb b(r/m),1 reg=5      spec: 0xD0 mod/reg/rm /5 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHRb %s,1",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 6: /* D0h 30h SALb b(r/m),1 reg=6      spec: 0xD0 mod/reg/rm /6 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SALb %s,1",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 7: /* D0h 38h SARb b(r/m),1 reg=7      spec: 0xD0 mod/reg/rm /7 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SARb %s,1",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with D1h */
        switch (mrm.reg()) {
            case 0: /* D1h 00h ROLd w(r/m),1 reg=0      spec: 0xD1 mod/reg/rm /0 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROL%s %s,1",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 1: /* D1h 08h RORd w(r/m),1 reg=1      spec: 0xD1 mod/reg/rm /1 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROR%s %s,1",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 2: /* D1h 10h RCLd w(r/m),1 reg=2      spec: 0xD1 mod/reg/rm /2 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCL%s %s,1",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 3: /* D1h 18h RCRd w(r/m),1 reg=3      spec: 0xD1 mod/reg/rm /3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCR%s %s,1",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 4: /* D1h 20h SHLd w(r/m),1 reg=4      spec: 0xD1 mod/reg/rm /4 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHL%s %s,1",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 5: /* D1h 28h SHRd w(r/m),1 reg=5      spec: 0xD1 mod/reg/rm /5 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHR%s %s,1",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 6: /* D1h 30h SALd w(r/m),1 reg=6      spec: 0xD1 mod/reg/rm /6 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SAL%s %s,1",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 7: /* D1h 38h SARd w(r/m),1 reg=7      spec: 0xD1 mod/reg/rm /7 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SAR%s %s,1",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with D2h */
        switch (mrm.reg()) {
            case 0: /* D2h 00h ROLb b(r/m),b(c) reg=0      spec: 0xD2 mod/reg/rm /0 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROLb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][1]);
                break;
            case 1: /* D2h 08h RORb b(r/m),b(c) reg=1      spec: 0xD2 mod/reg/rm /1 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RORb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][1]);
                break;
            case 2: /* D2h 10h RCLb b(r/m),b(c) reg=2      spec: 0xD2 mod/reg/rm /2 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCLb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][1]);
                break;
            case 3: /* D2h 18h RCRb b(r/m),b(c) reg=3      spec: 0xD2 mod/reg/rm /3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCRb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][1]);
                break;
            case 4: /* D2h 20h SHLb b(r/m),b(c) reg=4      spec: 0xD2 mod/reg/rm /4 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHLb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][1]);
                break;
            case 5: /* D2h 28h SHRb b(r/m),b(c) reg=5      spec: 0xD2 mod/reg/rm /5 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHRb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][1]);
                break;
            case 6: /* D2h 30h SALb b(r/m),b(c) reg=6      spec: 0xD2 mod/reg/rm /6 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SALb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][1]);
                break;
            case 7: /* D2h 38h SARb b(r/m),b(c) reg=7      spec: 0xD2 mod/reg/rm /7 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SARb %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][1]);
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with D3h */
        switch (mrm.reg()) {
            case 0: /* D3h 00h ROLd w(r/m),b(c) reg=0      spec: 0xD3 mod/reg/rm /0 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROL%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[1][1]);
                break;
            case 1: /* D3h 08h RORd w(r/m),b(c) reg=1      spec: 0xD3 mod/reg/rm /1 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ROR%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[1][1]);
                break;
            case 2: /* D3h 10h RCLd w(r/m),b(c) reg=2      spec: 0xD3 mod/reg/rm /2 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCL%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[1][1]);
                break;
            case 3: /* D3h 18h RCRd w(r/m),b(c) reg=3      spec: 0xD3 mod/reg/rm /3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCR%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[1][1]);
                break;
            case 4: /* D3h 20h SHLd w(r/m),b(c) reg=4      spec: 0xD3 mod/reg/rm /4 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHL%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[1][1]);
                break;
            case 5: /* D3h 28h SHRd w(r/m),b(c) reg=5      spec: 0xD3 mod/reg/rm /5 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SHR%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[1][1]);
                break;
            case 6: /* D3h 30h SALd w(r/m),b(c) reg=6      spec: 0xD3 mod/reg/rm /6 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SAL%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[1][1]);
                break;
            case 7: /* D3h 38h SARd w(r/m),b(c) reg=7      spec: 0xD3 mod/reg/rm /7 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SAR%s %s,%s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[1][1]);
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
/* End of opcodes starting with D3h */
    ...
    case 0xD4: /* D4h AAMb i      spec: 0xD4 ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"AAMb 0x%02lX",(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0xD5: /* D5h AADb i      spec: 0xD5 ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"AADb 0x%02lX",(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
...
/* Opcodes starting with D8h */
        switch (mrm.byte) {
            ...
            case 0x87: /* D8h 87h FADDf32 f32(r/m) mod=2 reg=0 rm=7      spec: 0xD8 mod/reg/rm /0 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FADDf32 %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_FPUREG,"f32"));
                break;
            ...
            case 0x8F: /* D8h 8Fh FMULf32 f32(r/m) mod=2 reg=1 rm=7      spec: 0xD8 mod/reg/rm /1 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FMULf32 %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_FPUREG,"f32"));
                break;
            ...
            case 0x97: /* D8h 97h FCOMf32 f32(r/m) mod=2 reg=2 rm=7      spec: 0xD8 mod/reg/rm /2 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCOMf32 %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_FPUREG,"f32"));
                break;
            ...
            case 0x9F: /* D8h 9Fh FCOMPf32 f32(r/m) mod=2 reg=3 rm=7      spec: 0xD8 mod/reg/rm /3 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCOMPf32 %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_FPUREG,"f32"));
                break;
            ...
            case 0xA7: /* D8h A7h FSUBf32 f32(r/m) mod=2 reg=4 rm=7      spec: 0xD8 mod/reg/rm /4 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUBf32 %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_FPUREG,"f32"));
                break;
            ...
            case 0xAF: /* D8h AFh FSUBRf32 f32(r/m) mod=2 reg=5 rm=7      spec: 0xD8 mod/reg/rm /5 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUBRf32 %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_FPUREG,"f32"));
                break;
            ...
            case 0xB7: /* D8h B7h FDIVf32 f32(r/m) mod=2 reg=6 rm=7      spec: 0xD8 mod/reg/rm /6 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIVf32 %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_FPUREG,"f32"));
                break;
            ...
            case 0xBF: /* D8h BFh FDIVRf32 f32(r/m) mod=2 reg=7 rm=7      spec: 0xD8 mod/reg/rm /7 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIVRf32 %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_FPUREG,"f32"));
                break;
            ...
            case 0xC7: /* D8h C7h FADD st(0),st(r/m) mod=3 reg=0 rm=7      spec: 0xD8 mod/reg/rm /0 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FADD ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xCF: /* D8h CFh FMUL st(0),st(r/m) mod=3 reg=1 rm=7      spec: 0xD8 mod/reg/rm /1 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FMUL ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xD7: /* D8h D7h FCOM st(0),st(r/m) mod=3 reg=2 rm=7      spec: 0xD8 mod/reg/rm /2 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCOM ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xDF: /* D8h DFh FCOMP st(0),st(r/m) mod=3 reg=3 rm=7      spec: 0xD8 mod/reg/rm /3 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCOMP ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xE7: /* D8h E7h FSUB st(0),st(r/m) mod=3 reg=4 rm=7      spec: 0xD8 mod/reg/rm /4 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUB ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xEF: /* D8h EFh FSUBR st(0),st(r/m) mod=3 reg=5 rm=7      spec: 0xD8 mod/reg/rm /5 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUBR ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xF7: /* D8h F7h FDIV st(0),st(r/m) mod=3 reg=6 rm=7      spec: 0xD8 mod/reg/rm /6 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIV ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xFF: /* D8h FFh FDIVR st(0),st(r/m) mod=3 reg=7 rm=7      spec: 0xD8 mod/reg/rm /7 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIVR ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with D9h */
        switch (mrm.byte) {
            ...
            case 0x87: /* D9h 87h FLDf32 f32(r/m) mod=2 reg=0 rm=7      spec: 0xD9 mod/reg/rm /0 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FLDf32 %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_FPUREG,"f32"));
                break;
            ...
            case 0x97: /* D9h 97h FSTf32 f32(r/m) mod=2 reg=2 rm=7      spec: 0xD9 mod/reg/rm /2 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTf32 %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_FPUREG,"f32"));
                break;
            ...
            case 0x9F: /* D9h 9Fh FSTPf32 f32(r/m) mod=2 reg=3 rm=7      spec: 0xD9 mod/reg/rm /3 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTPf32 %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_FPUREG,"f32"));
                break;
            ...
            case 0xA7: /* D9h A7h FLDENV fenv(r/m) mod=2 reg=4 rm=7      spec: 0xD9 mod/reg/rm /4 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FLDENV %s",IPDecPrint1632(addr32,mrm,sib,disp,0,RC_REG,"fenv"));
                break;
            ...
            case 0xAF: /* D9h AFh FLDCW w16(r/m) mod=2 reg=5 rm=7      spec: 0xD9 mod/reg/rm /5 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FLDCW %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0xB7: /* D9h B7h FSTENV fenv(r/m) mod=2 reg=6 rm=7      spec: 0xD9 mod/reg/rm /6 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTENV %s",IPDecPrint1632(addr32,mrm,sib,disp,0,RC_REG,"fenv"));
                break;
            ...
            case 0xBF: /* D9h BFh FSTCW w16(r/m) mod=2 reg=7 rm=7      spec: 0xD9 mod/reg/rm /7 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTCW %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0xC7: /* D9h C7h FLD st(0),st(r/m) mod=3 reg=0 rm=7      spec: 0xD9 mod/reg/rm /0 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FLD ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xCF: /* D9h CFh FXCH st(r/m) mod=3 reg=1 rm=7      spec: 0xD9 mod/reg/rm /1 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FXCH %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
...
/* Opcodes starting with DAh */
        switch (mrm.byte) {
            ...
            case 0x87: /* DAh 87h FADDd w32(r/m) mod=2 reg=0 rm=7      spec: 0xDA mod/reg/rm /0 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FADDd %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"));
                break;
            ...
            case 0x8F: /* DAh 8Fh FMULd w32(r/m) mod=2 reg=1 rm=7      spec: 0xDA mod/reg/rm /1 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FMULd %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"));
                break;
            ...
            case 0x97: /* DAh 97h FCOMd w32(r/m) mod=2 reg=2 rm=7      spec: 0xDA mod/reg/rm /2 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCOMd %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"));
                break;
            ...
            case 0x9F: /* DAh 9Fh FCOMPd w32(r/m) mod=2 reg=3 rm=7      spec: 0xDA mod/reg/rm /3 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCOMPd %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"));
                break;
            ...
            case 0xA7: /* DAh A7h FSUBd w32(r/m) mod=2 reg=4 rm=7      spec: 0xDA mod/reg/rm /4 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUBd %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"));
                break;
            ...
            case 0xAF: /* DAh AFh FSUBRd w32(r/m) mod=2 reg=5 rm=7      spec: 0xDA mod/reg/rm /5 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUBRd %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"));
                break;
            ...
            case 0xB7: /* DAh B7h FDIVd w32(r/m) mod=2 reg=6 rm=7      spec: 0xDA mod/reg/rm /6 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIVd %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"));
                break;
            ...
            case 0xBF: /* DAh BFh FDIVRd w32(r/m) mod=2 reg=7 rm=7      spec: 0xDA mod/reg/rm /7 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIVRd %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"));
                break;
...
/* Opcodes starting with DBh */
        switch (mrm.byte) {
            ...
            case 0x87: /* DBh 87h FLDd w32(r/m) mod=2 reg=0 rm=7      spec: 0xDB mod/reg/rm /0 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FLDd %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"));
                break;
            ...
            case 0x97: /* DBh 97h FSTd w32(r/m) mod=2 reg=2 rm=7      spec: 0xDB mod/reg/rm /2 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTd %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"));
                break;
            ...
            case 0x9F: /* DBh 9Fh FSTPd w32(r/m) mod=2 reg=3 rm=7      spec: 0xDB mod/reg/rm /3 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTPd %s",IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"));
                break;
            ...
            case 0xAF: /* DBh AFh FLDf80 f80(r/m) mod=2 reg=5 rm=7      spec: 0xDB mod/reg/rm /5 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FLDf80 %s",IPDecPrint1632(addr32,mrm,sib,disp,10,RC_FPUREG,"f80"));
                break;
            ...
            case 0xBF: /* DBh BFh FSTPf80 f80(r/m) mod=2 reg=7 rm=7      spec: 0xDB mod/reg/rm /7 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTPf80 %s",IPDecPrint1632(addr32,mrm,sib,disp,10,RC_FPUREG,"f80"));
                break;
...
/* Opcodes starting with DCh */
        switch (mrm.byte) {
            ...
            case 0x87: /* DCh 87h FADDf64 f64(r/m) mod=2 reg=0 rm=7      spec: 0xDC mod/reg/rm /0 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FADDf64 %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,"f64"));
                break;
            ...
            case 0x8F: /* DCh 8Fh FMULf64 f64(r/m) mod=2 reg=1 rm=7      spec: 0xDC mod/reg/rm /1 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FMULf64 %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,"f64"));
                break;
            ...
            case 0x97: /* DCh 97h FCOMf64 f64(r/m) mod=2 reg=2 rm=7      spec: 0xDC mod/reg/rm /2 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCOMf64 %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,"f64"));
                break;
            ...
            case 0x9F: /* DCh 9Fh FCOMPf64 f64(r/m) mod=2 reg=3 rm=7      spec: 0xDC mod/reg/rm /3 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCOMPf64 %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,"f64"));
                break;
            ...
            case 0xA7: /* DCh A7h FSUBf64 f64(r/m) mod=2 reg=4 rm=7      spec: 0xDC mod/reg/rm /4 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUBf64 %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,"f64"));
                break;
            ...
            case 0xAF: /* DCh AFh FSUBRf64 f64(r/m) mod=2 reg=5 rm=7      spec: 0xDC mod/reg/rm /5 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUBRf64 %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,"f64"));
                break;
            ...
            case 0xB7: /* DCh B7h FDIVf64 f64(r/m) mod=2 reg=6 rm=7      spec: 0xDC mod/reg/rm /6 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIVf64 %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,"f64"));
                break;
            ...
            case 0xBF: /* DCh BFh FDIVRf64 f64(r/m) mod=2 reg=7 rm=7      spec: 0xDC mod/reg/rm /7 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIVRf64 %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,"f64"));
                break;
            ...
            case 0xC7: /* DCh C7h FADD st(r/m),st(0) mod=3 reg=0 rm=7      spec: 0xDC mod/reg/rm /0 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FADD %s,ST(%u)",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""),0);
                break;
            ...
            case 0xCF: /* DCh CFh FMUL st(r/m),st(0) mod=3 reg=1 rm=7      spec: 0xDC mod/reg/rm /1 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FMUL %s,ST(%u)",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""),0);
                break;
            ...
            case 0xE7: /* DCh E7h FSUB st(r/m),st(0) mod=3 reg=4 rm=7      spec: 0xDC mod/reg/rm /4 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUB %s,ST(%u)",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""),0);
                break;
            ...
            case 0xEF: /* DCh EFh FSUBR st(r/m),st(0) mod=3 reg=5 rm=7      spec: 0xDC mod/reg/rm /5 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUBR %s,ST(%u)",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""),0);
                break;
            ...
            case 0xF7: /* DCh F7h FDIV st(r/m),st(0) mod=3 reg=6 rm=7      spec: 0xDC mod/reg/rm /6 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIV %s,ST(%u)",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""),0);
                break;
            ...
            case 0xFF: /* DCh FFh FDIVR st(r/m),st(0) mod=3 reg=7 rm=7      spec: 0xDC mod/reg/rm /7 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIVR %s,ST(%u)",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""),0);
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with DDh */
        switch (mrm.byte) {
            ...
            case 0x87: /* DDh 87h FLDf64 f64(r/m) mod=2 reg=0 rm=7      spec: 0xDD mod/reg/rm /0 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FLDf64 %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,"f64"));
                break;
            ...
            case 0x97: /* DDh 97h FSTf64 f64(r/m) mod=2 reg=2 rm=7      spec: 0xDD mod/reg/rm /2 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTf64 %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,"f64"));
                break;
            ...
            case 0x9F: /* DDh 9Fh FSTPf64 f64(r/m) mod=2 reg=3 rm=7      spec: 0xDD mod/reg/rm /3 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTPf64 %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,"f64"));
                break;
            ...
            case 0xA7: /* DDh A7h FRSTOR fstate(r/m) mod=2 reg=4 rm=7      spec: 0xDD mod/reg/rm /4 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FRSTOR %s",IPDecPrint1632(addr32,mrm,sib,disp,0,RC_REG,"fstate"));
                break;
            ...
            case 0xB7: /* DDh B7h FSAVE fstate(r/m) mod=2 reg=6 rm=7      spec: 0xDD mod/reg/rm /6 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSAVE %s",IPDecPrint1632(addr32,mrm,sib,disp,0,RC_REG,"fstate"));
                break;
            ...
            case 0xBF: /* DDh BFh FSTSW w16(r/m) mod=2 reg=7 rm=7      spec: 0xDD mod/reg/rm /7 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTSW %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0xC7: /* DDh C7h FFREE st(r/m) mod=3 reg=0 rm=7      spec: 0xDD mod/reg/rm /0 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FFREE %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xD7: /* DDh D7h FST st(r/m) mod=3 reg=2 rm=7      spec: 0xDD mod/reg/rm /2 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FST %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xDF: /* DDh DFh FSTP st(r/m) mod=3 reg=3 rm=7      spec: 0xDD mod/reg/rm /3 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTP %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xE7: /* DDh E7h FUCOM st(r/m) mod=3 reg=4 rm=7      spec: 0xDD mod/reg/rm mod==3 /4 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FUCOM %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xEF: /* DDh EFh FUCOMP st(r/m) mod=3 reg=5 rm=7      spec: 0xDD mod/reg/rm mod==3 /5 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FUCOMP %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
...
/* Opcodes starting with DEh */
        switch (mrm.byte) {
            ...
            case 0x87: /* DEh 87h FADDw w16(r/m) mod=2 reg=0 rm=7      spec: 0xDE mod/reg/rm /0 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FADDw %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0x8F: /* DEh 8Fh FMULw w16(r/m) mod=2 reg=1 rm=7      spec: 0xDE mod/reg/rm /1 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FMULw %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0x97: /* DEh 97h FCOMw w16(r/m) mod=2 reg=2 rm=7      spec: 0xDE mod/reg/rm /2 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCOMw %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0x9F: /* DEh 9Fh FCOMPw w16(r/m) mod=2 reg=3 rm=7      spec: 0xDE mod/reg/rm /3 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCOMPw %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0xA7: /* DEh A7h FSUBw w16(r/m) mod=2 reg=4 rm=7      spec: 0xDE mod/reg/rm /4 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUBw %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0xAF: /* DEh AFh FSUBRw w16(r/m) mod=2 reg=5 rm=7      spec: 0xDE mod/reg/rm /5 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUBRw %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0xB7: /* DEh B7h FDIVw w16(r/m) mod=2 reg=6 rm=7      spec: 0xDE mod/reg/rm /6 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIVw %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0xBF: /* DEh BFh FDIVRw w16(r/m) mod=2 reg=7 rm=7      spec: 0xDE mod/reg/rm /7 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIVRw %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0xC7: /* DEh C7h FADDP st(r/m),st(0) mod=3 reg=0 rm=7      spec: 0xDE mod/reg/rm /0 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FADDP %s,ST(%u)",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""),0);
                break;
            ...
            case 0xCF: /* DEh CFh FMULP st(r/m),st(0) mod=3 reg=1 rm=7      spec: 0xDE mod/reg/rm /1 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FMULP %s,ST(%u)",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""),0);
                break;
            ...
            case 0xE7: /* DEh E7h FSUBP st(r/m),st(0) mod=3 reg=4 rm=7      spec: 0xDE mod/reg/rm /4 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUBP %s,ST(%u)",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""),0);
                break;
            ...
            case 0xEF: /* DEh EFh FSUBRP st(r/m),st(0) mod=3 reg=5 rm=7      spec: 0xDE mod/reg/rm /5 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSUBRP %s,ST(%u)",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""),0);
                break;
            ...
            case 0xF7: /* DEh F7h FDIVP st(r/m),st(0) mod=3 reg=6 rm=7      spec: 0xDE mod/reg/rm /6 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIVP %s,ST(%u)",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""),0);
                break;
            ...
            case 0xFF: /* DEh FFh FDIVRP st(r/m),st(0) mod=3 reg=7 rm=7      spec: 0xDE mod/reg/rm /7 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FDIVRP %s,ST(%u)",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""),0);
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with DFh */
        switch (mrm.byte) {
            ...
            case 0x87: /* DFh 87h FLDw w16(r/m) mod=2 reg=0 rm=7      spec: 0xDF mod/reg/rm /0 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FLDw %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0x97: /* DFh 97h FSTw w16(r/m) mod=2 reg=2 rm=7      spec: 0xDF mod/reg/rm /2 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTw %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0x9F: /* DFh 9Fh FSTPw w16(r/m) mod=2 reg=3 rm=7      spec: 0xDF mod/reg/rm /3 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTPw %s",IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"));
                break;
            ...
            case 0xA7: /* DFh A7h FLDfbcd fbcd(r/m) mod=2 reg=4 rm=7      spec: 0xDF mod/reg/rm /4 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FLDfbcd %s",IPDecPrint1632(addr32,mrm,sib,disp,10,RC_FPUREG,"fbcd"));
                break;
            ...
            case 0xAF: /* DFh AFh FLDq w64(r/m) mod=2 reg=5 rm=7      spec: 0xDF mod/reg/rm /5 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FLDq %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_REG,"w64"));
                break;
            ...
            case 0xB7: /* DFh B7h FSTPfbcd fbcd(r/m) mod=2 reg=6 rm=7      spec: 0xDF mod/reg/rm /6 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTPfbcd %s",IPDecPrint1632(addr32,mrm,sib,disp,10,RC_FPUREG,"fbcd"));
                break;
            ...
            case 0xBF: /* DFh BFh FSTPq w64(r/m) mod=2 reg=7 rm=7      spec: 0xDF mod/reg/rm /7 mod!=3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTPq %s",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_REG,"w64"));
                break;
            ...
            case 0xE0: /* DFh E0h FSTSWd w(a) mod=3 reg=4 rm=0      spec: 0xDF 0xE0 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FSTSW%s %s",code32?"d":"w",CPUregsN[code32?4:2][0]);
                break;
...
/* End of opcodes starting with DFh */
    ...
    case 0xE0: /* E0h LOOPNZd w(i+ip)      spec: 0xE0 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LOOPNZ%s 0x%02lX",code32?"d":"w",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0xE1: /* E1h LOOPZd w(i+ip)      spec: 0xE1 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LOOPZ%s 0x%02lX",code32?"d":"w",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0xE2: /* E2h LOOPd w(i+ip)      spec: 0xE2 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LOOP%s 0x%02lX",code32?"d":"w",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0xE3: /* E3h JCXZd w(i+ip)      spec: 0xE3 ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JCXZ%s 0x%02lX",code32?"d":"w",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0xE4: /* E4h INb b(a),i      spec: 0xE4 ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"INb %s,0x%02lX",CPUregsN[1][0],(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0xE5: /* E5h INd w(a),i      spec: 0xE5 ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IN%s %s,0x%02lX",code32?"d":"w",CPUregsN[code32?4:2][0],(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    case 0xE6: /* E6h OUTb i,b(a)      spec: 0xE6 ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"OUTb 0x%02lX,%s",(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL),CPUregsN[1][0]);
        break;
    case 0xE7: /* E7h OUTd i,w(a)      spec: 0xE7 ib */
        imm=IPFB();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"OUT%s 0x%02lX,%s",code32?"d":"w",(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL),CPUregsN[code32?4:2][0]);
        break;
    ...
    case 0xEB: /* EBh JMPd w(i+ip)      spec: 0xEB ibs */
        imm=IPFBsigned();
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JMP%s 0x%02lX",code32?"d":"w",(unsigned long)((uint32_t)(imm+IPval()))&(code32?0xFFFFFFFFUL:0xFFFFUL));
        break;
    ...
    case 0xED: /* EDh INd w(a),w16(d)      spec: 0xED */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IN%s %s,%s",code32?"d":"w",CPUregsN[code32?4:2][0],CPUregsN[2][2]);
        break;
    ...
    case 0xEF: /* EFh OUTd w16(d),w(a)      spec: 0xEF */
        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"OUT%s %s,%s",code32?"d":"w",CPUregsN[2][2],CPUregsN[code32?4:2][0]);
        break;
...
/* Opcodes starting with F6h */
        switch (mrm.reg()) {
            case 0: /* F6h 00h TESTb b(r/m),i reg=0      spec: 0xF6 mod/reg/rm /0 ib */
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"TESTb %s,0x%02lX",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
            /* reg 1 not defined */
            case 2: /* F6h 10h NOTb b(r/m) reg=2      spec: 0xF6 mod/reg/rm /2 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"NOTb %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 3: /* F6h 18h NEGb b(r/m) reg=3      spec: 0xF6 mod/reg/rm /3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"NEGb %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 4: /* F6h 20h MULb b(r/m) reg=4      spec: 0xF6 mod/reg/rm /4 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MULb %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 5: /* F6h 28h IMULb b(r/m) reg=5      spec: 0xF6 mod/reg/rm /5 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IMULb %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 6: /* F6h 30h DIVb b(r/m) reg=6      spec: 0xF6 mod/reg/rm /6 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"DIVb %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 7: /* F6h 38h IDIVb b(r/m) reg=7      spec: 0xF6 mod/reg/rm /7 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IDIVb %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with F7h */
        switch (mrm.reg()) {
            ...
            case 3: /* F7h 18h NEGd w(r/m) reg=3      spec: 0xF7 mod/reg/rm /3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"NEG%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 4: /* F7h 20h MULd w(r/m) reg=4      spec: 0xF7 mod/reg/rm /4 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MUL%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 5: /* F7h 28h IMULd w(r/m) reg=5      spec: 0xF7 mod/reg/rm /5 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IMUL%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 6: /* F7h 30h DIVd w(r/m) reg=6      spec: 0xF7 mod/reg/rm /6 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"DIV%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 7: /* F7h 38h IDIVd w(r/m) reg=7      spec: 0xF7 mod/reg/rm /7 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IDIV%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            default:
                goto _x86decode_illegal_opcode;
        };
...
/* Opcodes starting with FEh */
        switch (mrm.reg()) {
            case 0: /* FEh 00h INCb b(r/m) reg=0      spec: 0xFE mod/reg/rm /0 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"INCb %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 1: /* FEh 08h DECb b(r/m) reg=1      spec: 0xFE mod/reg/rm /1 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"DECb %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            /* reg 2 not defined */
            /* reg 3 not defined */
            /* reg 4 not defined */
...
/* Opcodes starting with FFh */
        switch (mrm.reg()) {
            case 0: /* FFh 00h INCd w(r/m) reg=0      spec: 0xFF mod/reg/rm /0 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"INC%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 1: /* FFh 08h DECd w(r/m) reg=1      spec: 0xFF mod/reg/rm /1 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"DEC%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 2: /* FFh 10h CALLd w(r/m) reg=2      spec: 0xFF mod/reg/rm /2 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CALL%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 3: /* FFh 18h CALLFd w(r/m) reg=3      spec: 0xFF mod/reg/rm /3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CALLF%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 4: /* FFh 20h JMPd w(r/m) reg=4      spec: 0xFF mod/reg/rm /4 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JMP%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 5: /* FFh 28h JMPFd w(r/m) reg=5      spec: 0xFF mod/reg/rm /5 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"JMPF%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 6: /* FFh 30h PUSHd w(r/m) reg=6      spec: 0xFF mod/reg/rm /6 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PUSH%s %s",code32?"d":"w",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            /* reg 7 not defined */
            default:
                goto _x86decode_illegal_opcode;
