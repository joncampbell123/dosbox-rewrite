...
/* End of opcodes starting with 0Fh 01h */
            ...
            case 0x10: /* 0Fh 10h UMOV b(r/m),b(reg)      spec: 0x0F 0x10 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"UMOV %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
                break;
            case 0x11: /* 0Fh 11h UMOV w(r/m),w(reg)      spec: 0x0F 0x11 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"UMOV %s,%s",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()]);
                break;
            case 0x12: /* 0Fh 12h UMOV b(reg),b(r/m)      spec: 0x0F 0x12 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"UMOV %s,%s",CPUregsN[1][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                break;
            case 0x13: /* 0Fh 13h UMOV w(reg),w(r/m)      spec: 0x0F 0x13 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"UMOV %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
...
/* Opcodes starting with 0Fh 24h */
                switch (mrm.byte) {
                    ...
                    case 0xC0: /* 0Fh 24h C0h MOVd w32(r/m),tr(reg) mod=3 reg=0 rm=0      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xC1: /* 0Fh 24h C1h MOVd w32(r/m),tr(reg) mod=3 reg=0 rm=1      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xC2: /* 0Fh 24h C2h MOVd w32(r/m),tr(reg) mod=3 reg=0 rm=2      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xC3: /* 0Fh 24h C3h MOVd w32(r/m),tr(reg) mod=3 reg=0 rm=3      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xC4: /* 0Fh 24h C4h MOVd w32(r/m),tr(reg) mod=3 reg=0 rm=4      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xC5: /* 0Fh 24h C5h MOVd w32(r/m),tr(reg) mod=3 reg=0 rm=5      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xC6: /* 0Fh 24h C6h MOVd w32(r/m),tr(reg) mod=3 reg=0 rm=6      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xC7: /* 0Fh 24h C7h MOVd w32(r/m),tr(reg) mod=3 reg=0 rm=7      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xC8: /* 0Fh 24h C8h MOVd w32(r/m),tr(reg) mod=3 reg=1 rm=0      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xC9: /* 0Fh 24h C9h MOVd w32(r/m),tr(reg) mod=3 reg=1 rm=1      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xCA: /* 0Fh 24h CAh MOVd w32(r/m),tr(reg) mod=3 reg=1 rm=2      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xCB: /* 0Fh 24h CBh MOVd w32(r/m),tr(reg) mod=3 reg=1 rm=3      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xCC: /* 0Fh 24h CCh MOVd w32(r/m),tr(reg) mod=3 reg=1 rm=4      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xCD: /* 0Fh 24h CDh MOVd w32(r/m),tr(reg) mod=3 reg=1 rm=5      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xCE: /* 0Fh 24h CEh MOVd w32(r/m),tr(reg) mod=3 reg=1 rm=6      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xCF: /* 0Fh 24h CFh MOVd w32(r/m),tr(reg) mod=3 reg=1 rm=7      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xD0: /* 0Fh 24h D0h MOVd w32(r/m),tr(reg) mod=3 reg=2 rm=0      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xD1: /* 0Fh 24h D1h MOVd w32(r/m),tr(reg) mod=3 reg=2 rm=1      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xD2: /* 0Fh 24h D2h MOVd w32(r/m),tr(reg) mod=3 reg=2 rm=2      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xD3: /* 0Fh 24h D3h MOVd w32(r/m),tr(reg) mod=3 reg=2 rm=3      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xD4: /* 0Fh 24h D4h MOVd w32(r/m),tr(reg) mod=3 reg=2 rm=4      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xD5: /* 0Fh 24h D5h MOVd w32(r/m),tr(reg) mod=3 reg=2 rm=5      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xD6: /* 0Fh 24h D6h MOVd w32(r/m),tr(reg) mod=3 reg=2 rm=6      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xD7: /* 0Fh 24h D7h MOVd w32(r/m),tr(reg) mod=3 reg=2 rm=7      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xD8: /* 0Fh 24h D8h MOVd w32(r/m),tr(reg) mod=3 reg=3 rm=0      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xD9: /* 0Fh 24h D9h MOVd w32(r/m),tr(reg) mod=3 reg=3 rm=1      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xDA: /* 0Fh 24h DAh MOVd w32(r/m),tr(reg) mod=3 reg=3 rm=2      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xDB: /* 0Fh 24h DBh MOVd w32(r/m),tr(reg) mod=3 reg=3 rm=3      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xDC: /* 0Fh 24h DCh MOVd w32(r/m),tr(reg) mod=3 reg=3 rm=4      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xDD: /* 0Fh 24h DDh MOVd w32(r/m),tr(reg) mod=3 reg=3 rm=5      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xDE: /* 0Fh 24h DEh MOVd w32(r/m),tr(reg) mod=3 reg=3 rm=6      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xDF: /* 0Fh 24h DFh MOVd w32(r/m),tr(reg) mod=3 reg=3 rm=7      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xE0: /* 0Fh 24h E0h MOVd w32(r/m),tr(reg) mod=3 reg=4 rm=0      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xE1: /* 0Fh 24h E1h MOVd w32(r/m),tr(reg) mod=3 reg=4 rm=1      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xE2: /* 0Fh 24h E2h MOVd w32(r/m),tr(reg) mod=3 reg=4 rm=2      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xE3: /* 0Fh 24h E3h MOVd w32(r/m),tr(reg) mod=3 reg=4 rm=3      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xE4: /* 0Fh 24h E4h MOVd w32(r/m),tr(reg) mod=3 reg=4 rm=4      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xE5: /* 0Fh 24h E5h MOVd w32(r/m),tr(reg) mod=3 reg=4 rm=5      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xE6: /* 0Fh 24h E6h MOVd w32(r/m),tr(reg) mod=3 reg=4 rm=6      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xE7: /* 0Fh 24h E7h MOVd w32(r/m),tr(reg) mod=3 reg=4 rm=7      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xE8: /* 0Fh 24h E8h MOVd w32(r/m),tr(reg) mod=3 reg=5 rm=0      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xE9: /* 0Fh 24h E9h MOVd w32(r/m),tr(reg) mod=3 reg=5 rm=1      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xEA: /* 0Fh 24h EAh MOVd w32(r/m),tr(reg) mod=3 reg=5 rm=2      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xEB: /* 0Fh 24h EBh MOVd w32(r/m),tr(reg) mod=3 reg=5 rm=3      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xEC: /* 0Fh 24h ECh MOVd w32(r/m),tr(reg) mod=3 reg=5 rm=4      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xED: /* 0Fh 24h EDh MOVd w32(r/m),tr(reg) mod=3 reg=5 rm=5      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xEE: /* 0Fh 24h EEh MOVd w32(r/m),tr(reg) mod=3 reg=5 rm=6      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xEF: /* 0Fh 24h EFh MOVd w32(r/m),tr(reg) mod=3 reg=5 rm=7      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xF0: /* 0Fh 24h F0h MOVd w32(r/m),tr(reg) mod=3 reg=6 rm=0      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xF1: /* 0Fh 24h F1h MOVd w32(r/m),tr(reg) mod=3 reg=6 rm=1      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xF2: /* 0Fh 24h F2h MOVd w32(r/m),tr(reg) mod=3 reg=6 rm=2      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xF3: /* 0Fh 24h F3h MOVd w32(r/m),tr(reg) mod=3 reg=6 rm=3      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xF4: /* 0Fh 24h F4h MOVd w32(r/m),tr(reg) mod=3 reg=6 rm=4      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xF5: /* 0Fh 24h F5h MOVd w32(r/m),tr(reg) mod=3 reg=6 rm=5      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xF6: /* 0Fh 24h F6h MOVd w32(r/m),tr(reg) mod=3 reg=6 rm=6      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xF7: /* 0Fh 24h F7h MOVd w32(r/m),tr(reg) mod=3 reg=6 rm=7      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xF8: /* 0Fh 24h F8h MOVd w32(r/m),tr(reg) mod=3 reg=7 rm=0      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xF9: /* 0Fh 24h F9h MOVd w32(r/m),tr(reg) mod=3 reg=7 rm=1      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xFA: /* 0Fh 24h FAh MOVd w32(r/m),tr(reg) mod=3 reg=7 rm=2      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xFB: /* 0Fh 24h FBh MOVd w32(r/m),tr(reg) mod=3 reg=7 rm=3      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xFC: /* 0Fh 24h FCh MOVd w32(r/m),tr(reg) mod=3 reg=7 rm=4      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xFD: /* 0Fh 24h FDh MOVd w32(r/m),tr(reg) mod=3 reg=7 rm=5      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xFE: /* 0Fh 24h FEh MOVd w32(r/m),tr(reg) mod=3 reg=7 rm=6      spec: 0x0F 0x24 mod/reg/rm mod==3 */
                    case 0xFF: /* 0Fh 24h FFh MOVd w32(r/m),tr(reg) mod=3 reg=7 rm=7      spec: 0x0F 0x24 mod/reg/rm mod==3 */
...
/* Opcodes starting with 0Fh 26h */
                switch (mrm.byte) {
                    ...
                    case 0xC0: /* 0Fh 26h C0h MOVd tr(reg),w32(r/m) mod=3 reg=0 rm=0      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xC1: /* 0Fh 26h C1h MOVd tr(reg),w32(r/m) mod=3 reg=0 rm=1      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xC2: /* 0Fh 26h C2h MOVd tr(reg),w32(r/m) mod=3 reg=0 rm=2      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xC3: /* 0Fh 26h C3h MOVd tr(reg),w32(r/m) mod=3 reg=0 rm=3      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xC4: /* 0Fh 26h C4h MOVd tr(reg),w32(r/m) mod=3 reg=0 rm=4      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xC5: /* 0Fh 26h C5h MOVd tr(reg),w32(r/m) mod=3 reg=0 rm=5      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xC6: /* 0Fh 26h C6h MOVd tr(reg),w32(r/m) mod=3 reg=0 rm=6      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xC7: /* 0Fh 26h C7h MOVd tr(reg),w32(r/m) mod=3 reg=0 rm=7      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xC8: /* 0Fh 26h C8h MOVd tr(reg),w32(r/m) mod=3 reg=1 rm=0      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xC9: /* 0Fh 26h C9h MOVd tr(reg),w32(r/m) mod=3 reg=1 rm=1      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xCA: /* 0Fh 26h CAh MOVd tr(reg),w32(r/m) mod=3 reg=1 rm=2      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xCB: /* 0Fh 26h CBh MOVd tr(reg),w32(r/m) mod=3 reg=1 rm=3      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xCC: /* 0Fh 26h CCh MOVd tr(reg),w32(r/m) mod=3 reg=1 rm=4      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xCD: /* 0Fh 26h CDh MOVd tr(reg),w32(r/m) mod=3 reg=1 rm=5      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xCE: /* 0Fh 26h CEh MOVd tr(reg),w32(r/m) mod=3 reg=1 rm=6      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xCF: /* 0Fh 26h CFh MOVd tr(reg),w32(r/m) mod=3 reg=1 rm=7      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xD0: /* 0Fh 26h D0h MOVd tr(reg),w32(r/m) mod=3 reg=2 rm=0      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xD1: /* 0Fh 26h D1h MOVd tr(reg),w32(r/m) mod=3 reg=2 rm=1      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xD2: /* 0Fh 26h D2h MOVd tr(reg),w32(r/m) mod=3 reg=2 rm=2      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xD3: /* 0Fh 26h D3h MOVd tr(reg),w32(r/m) mod=3 reg=2 rm=3      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xD4: /* 0Fh 26h D4h MOVd tr(reg),w32(r/m) mod=3 reg=2 rm=4      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xD5: /* 0Fh 26h D5h MOVd tr(reg),w32(r/m) mod=3 reg=2 rm=5      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xD6: /* 0Fh 26h D6h MOVd tr(reg),w32(r/m) mod=3 reg=2 rm=6      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xD7: /* 0Fh 26h D7h MOVd tr(reg),w32(r/m) mod=3 reg=2 rm=7      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xD8: /* 0Fh 26h D8h MOVd tr(reg),w32(r/m) mod=3 reg=3 rm=0      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xD9: /* 0Fh 26h D9h MOVd tr(reg),w32(r/m) mod=3 reg=3 rm=1      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xDA: /* 0Fh 26h DAh MOVd tr(reg),w32(r/m) mod=3 reg=3 rm=2      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xDB: /* 0Fh 26h DBh MOVd tr(reg),w32(r/m) mod=3 reg=3 rm=3      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xDC: /* 0Fh 26h DCh MOVd tr(reg),w32(r/m) mod=3 reg=3 rm=4      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xDD: /* 0Fh 26h DDh MOVd tr(reg),w32(r/m) mod=3 reg=3 rm=5      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xDE: /* 0Fh 26h DEh MOVd tr(reg),w32(r/m) mod=3 reg=3 rm=6      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xDF: /* 0Fh 26h DFh MOVd tr(reg),w32(r/m) mod=3 reg=3 rm=7      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xE0: /* 0Fh 26h E0h MOVd tr(reg),w32(r/m) mod=3 reg=4 rm=0      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xE1: /* 0Fh 26h E1h MOVd tr(reg),w32(r/m) mod=3 reg=4 rm=1      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xE2: /* 0Fh 26h E2h MOVd tr(reg),w32(r/m) mod=3 reg=4 rm=2      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xE3: /* 0Fh 26h E3h MOVd tr(reg),w32(r/m) mod=3 reg=4 rm=3      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xE4: /* 0Fh 26h E4h MOVd tr(reg),w32(r/m) mod=3 reg=4 rm=4      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xE5: /* 0Fh 26h E5h MOVd tr(reg),w32(r/m) mod=3 reg=4 rm=5      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xE6: /* 0Fh 26h E6h MOVd tr(reg),w32(r/m) mod=3 reg=4 rm=6      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xE7: /* 0Fh 26h E7h MOVd tr(reg),w32(r/m) mod=3 reg=4 rm=7      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xE8: /* 0Fh 26h E8h MOVd tr(reg),w32(r/m) mod=3 reg=5 rm=0      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xE9: /* 0Fh 26h E9h MOVd tr(reg),w32(r/m) mod=3 reg=5 rm=1      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xEA: /* 0Fh 26h EAh MOVd tr(reg),w32(r/m) mod=3 reg=5 rm=2      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xEB: /* 0Fh 26h EBh MOVd tr(reg),w32(r/m) mod=3 reg=5 rm=3      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xEC: /* 0Fh 26h ECh MOVd tr(reg),w32(r/m) mod=3 reg=5 rm=4      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xED: /* 0Fh 26h EDh MOVd tr(reg),w32(r/m) mod=3 reg=5 rm=5      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xEE: /* 0Fh 26h EEh MOVd tr(reg),w32(r/m) mod=3 reg=5 rm=6      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xEF: /* 0Fh 26h EFh MOVd tr(reg),w32(r/m) mod=3 reg=5 rm=7      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xF0: /* 0Fh 26h F0h MOVd tr(reg),w32(r/m) mod=3 reg=6 rm=0      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xF1: /* 0Fh 26h F1h MOVd tr(reg),w32(r/m) mod=3 reg=6 rm=1      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xF2: /* 0Fh 26h F2h MOVd tr(reg),w32(r/m) mod=3 reg=6 rm=2      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xF3: /* 0Fh 26h F3h MOVd tr(reg),w32(r/m) mod=3 reg=6 rm=3      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xF4: /* 0Fh 26h F4h MOVd tr(reg),w32(r/m) mod=3 reg=6 rm=4      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xF5: /* 0Fh 26h F5h MOVd tr(reg),w32(r/m) mod=3 reg=6 rm=5      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xF6: /* 0Fh 26h F6h MOVd tr(reg),w32(r/m) mod=3 reg=6 rm=6      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xF7: /* 0Fh 26h F7h MOVd tr(reg),w32(r/m) mod=3 reg=6 rm=7      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xF8: /* 0Fh 26h F8h MOVd tr(reg),w32(r/m) mod=3 reg=7 rm=0      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xF9: /* 0Fh 26h F9h MOVd tr(reg),w32(r/m) mod=3 reg=7 rm=1      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xFA: /* 0Fh 26h FAh MOVd tr(reg),w32(r/m) mod=3 reg=7 rm=2      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xFB: /* 0Fh 26h FBh MOVd tr(reg),w32(r/m) mod=3 reg=7 rm=3      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xFC: /* 0Fh 26h FCh MOVd tr(reg),w32(r/m) mod=3 reg=7 rm=4      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xFD: /* 0Fh 26h FDh MOVd tr(reg),w32(r/m) mod=3 reg=7 rm=5      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xFE: /* 0Fh 26h FEh MOVd tr(reg),w32(r/m) mod=3 reg=7 rm=6      spec: 0x0F 0x26 mod/reg/rm mod==3 */
                    case 0xFF: /* 0Fh 26h FFh MOVd tr(reg),w32(r/m) mod=3 reg=7 rm=7      spec: 0x0F 0x26 mod/reg/rm mod==3 */
...
/* End of opcodes starting with 0Fh 26h */
            ...
            case 0xA6: /* 0Fh A6h XBTS w(reg),w(r/m),b(c)      spec: 0x0F 0xA6 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XBTS %s,%s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[1][1]);
                break;
            case 0xA7: /* 0Fh A7h IBTS w(r/m),w(reg),b(c)      spec: 0x0F 0xA7 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"IBTS %s,%s,%s",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"),CPUregsN[code32?4:2][mrm.reg()],CPUregsN[1][1]);
                break;
