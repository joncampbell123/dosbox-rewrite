...
/* Opcodes starting with 0Fh 01h */
                switch (mrm.byte) {
                    ...
                    case 0xBF: /* 0Fh 01h BFh INVLPG b(r/m) mod=2 reg=7 rm=7      spec: 0x0F 0x01 mod/reg/rm mod!=3 /7 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"INVLPG %s",IPDecPrint16(mrm,disp,1,RC_REG,"b"));
                        break;
...
/* End of opcodes starting with 0Fh 26h */
            ...
            case 0xA5: /* 0Fh A5h SHLDw w(r/m),w(reg),b(c)      spec: 0x0F 0xA5 mod/reg/rm */
                ...
                break;
            case 0xA6: /* 0Fh A6h CMPXCHGb b(r/m),b(reg)      spec: 0x0F 0xA6 mod/reg/rm */
                IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPXCHGb %s,%s",IPDecPrint16(mrm,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
                break;
            case 0xA7: /* 0Fh A7h CMPXCHGw w(r/m),w(reg)      spec: 0x0F 0xA7 mod/reg/rm */
                IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPXCHGw %s,%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
                break;
...
/* End of opcodes starting with 0Fh BAh */
            ...
            case 0xC0: /* 0Fh C0h XADDb b(r/m),b(reg)      spec: 0x0F 0xC0 mod/reg/rm */
                IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XADDb %s,%s",IPDecPrint16(mrm,disp,1,RC_REG,"b"),CPUregsN[1][mrm.reg()]);
                break;
            case 0xC1: /* 0Fh C1h XADDw w(r/m),w(reg)      spec: 0x0F 0xC1 mod/reg/rm */
                IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XADDw %s,%s",IPDecPrint16(mrm,disp,2,RC_REG,"w"),CPUregsN[2][mrm.reg()]);
                break;
            ...
            case 0xC8: /* 0Fh C8h BSWAPw w(reg) reg=0      spec: 0x0F range(0xC8,0xCF) reg=op02 */
            case 0xC9: /* 0Fh C9h BSWAPw w(reg) reg=1      spec: 0x0F range(0xC8,0xCF) reg=op02 */
            case 0xCA: /* 0Fh CAh BSWAPw w(reg) reg=2      spec: 0x0F range(0xC8,0xCF) reg=op02 */
            case 0xCB: /* 0Fh CBh BSWAPw w(reg) reg=3      spec: 0x0F range(0xC8,0xCF) reg=op02 */
            case 0xCC: /* 0Fh CCh BSWAPw w(reg) reg=4      spec: 0x0F range(0xC8,0xCF) reg=op02 */
            case 0xCD: /* 0Fh CDh BSWAPw w(reg) reg=5      spec: 0x0F range(0xC8,0xCF) reg=op02 */
            case 0xCE: /* 0Fh CEh BSWAPw w(reg) reg=6      spec: 0x0F range(0xC8,0xCF) reg=op02 */
            case 0xCF: /* 0Fh CFh BSWAPw w(reg) reg=7      spec: 0x0F range(0xC8,0xCF) reg=op02 */
