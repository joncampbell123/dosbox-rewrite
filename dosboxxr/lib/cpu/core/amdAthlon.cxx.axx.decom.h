...
/* Opcodes starting with 0Fh 0Dh */
                switch (mrm.byte) {
                    ...
                    case 0x87: /* 0Fh 0Dh 87h PREFETCH b(r/m) mod=2 reg=0 rm=7      spec: 0x0F 0x0D mod/reg/rm mod!=3 /0 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PREFETCH %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                        break;
                    ...
                    case 0x8F: /* 0Fh 0Dh 8Fh PREFETCHW b(r/m) mod=2 reg=1 rm=7      spec: 0x0F 0x0D mod/reg/rm mod!=3 /1 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PREFETCHW %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                        break;
...
/* Opcodes starting with 0Fh 0Fh */
                ...
                switch (op=IPFB()) {
                    ...
                    case 0x0C: /* 0Fh 0Fh 0Ch PI2FW mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0x0C) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PI2FW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    case 0x0D: /* 0Fh 0Fh 0Dh PI2FD mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0x0D) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PI2FD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    ...
                    case 0x1C: /* 0Fh 0Fh 1Ch PF2IW mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0x1C) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PF2IW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    case 0x1D: /* 0Fh 0Fh 1Dh PF2ID mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0x1D) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PF2ID MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    ...
                    case 0x8A: /* 0Fh 0Fh 8Ah PFNACC mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0x8A) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFNACC MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    ...
                    case 0x8E: /* 0Fh 0Fh 8Eh PFPNACC mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0x8E) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFPNACC MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    /* opcode 0Fh 0Fh 8Fh  not defined */
                    case 0x90: /* 0Fh 0Fh 90h PFCMPGE mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0x90) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFCMPGE MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    ...
                    case 0x94: /* 0Fh 0Fh 94h PFMIN mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0x94) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFMIN MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    /* opcode 0Fh 0Fh 95h  not defined */
                    case 0x96: /* 0Fh 0Fh 96h PFRCP mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0x96) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFRCP MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    case 0x97: /* 0Fh 0Fh 97h PFRSQRT mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0x97) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFRSQRT MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    ...
                    case 0x9A: /* 0Fh 0Fh 9Ah PFSUB mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0x9A) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFSUB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    ...
                    case 0x9E: /* 0Fh 0Fh 9Eh PFADD mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0x9E) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFADD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    /* opcode 0Fh 0Fh 9Fh  not defined */
                    case 0xA0: /* 0Fh 0Fh A0h PFCMPGT mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0xA0) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFCMPGT MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    ...
                    case 0xA4: /* 0Fh 0Fh A4h PFMAX mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0xA4) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFMAX MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    /* opcode 0Fh 0Fh A5h  not defined */
                    case 0xA6: /* 0Fh 0Fh A6h PFRCPIT1 mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0xA6) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFRCPIT1 MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    case 0xA7: /* 0Fh 0Fh A7h PFRSQIT1 mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0xA7) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFRSQIT1 MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    ...
                    case 0xAA: /* 0Fh 0Fh AAh PFSUBR mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0xAA) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFSUBR MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    ...
                    case 0xAE: /* 0Fh 0Fh AEh PFACC mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0xAE) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFACC MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    /* opcode 0Fh 0Fh AFh  not defined */
                    case 0xB0: /* 0Fh 0Fh B0h PFCMPEQ mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0xB0) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFCMPEQ MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    ...
                    case 0xB4: /* 0Fh 0Fh B4h PFMUL mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0xB4) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFMUL MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    /* opcode 0Fh 0Fh B5h  not defined */
                    case 0xB6: /* 0Fh 0Fh B6h PFRCPIT2 mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0xB6) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PFRCPIT2 MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    ...
                    case 0xBB: /* 0Fh 0Fh BBh PSWAPD mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0xBB) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSWAPD MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    ...
                    case 0xBF: /* 0Fh 0Fh BFh PAVGUSB mmx(reg),mmx(r/m)      spec: 0x0F 0x0F mod/reg/rm amd3dnow(0xBF) */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PAVGUSB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
...
/* End of opcodes starting with 0Fh 23h */
            ...
            case 0x70: /* 0Fh 70h PSHUFW mmx(reg),mmx(r/m)      spec: 0x0F 0x70 mod/reg/rm ib */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSHUFW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
...
/* Opcodes starting with 0Fh D7h */
                switch (mrm.byte) {
                    ...
                    case 0xFF: /* 0Fh D7h FFh PMOVMSKB w32(reg),mmx(r/m) mod=3 reg=7 rm=7      spec: 0x0F 0xD7 mod/reg/rm mod==3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMOVMSKB %s,%s",CPUregsN[4][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    default:
                        goto _x86decode_illegal_opcode;
                };
/* End of opcodes starting with 0Fh D7h */
            ...
            case 0xDA: /* 0Fh DAh PMINUB mmx(reg),mmx(r/m)      spec: 0x0F 0xDA mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMINUB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xDE: /* 0Fh DEh PMAXUB mmx(reg),mmx(r/m)      spec: 0x0F 0xDE mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMAXUB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xE0: /* 0Fh E0h PAVGB mmx(reg),mmx(r/m)      spec: 0x0F 0xE0 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PAVGB MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xE3: /* 0Fh E3h PAVGW mmx(reg),mmx(r/m)      spec: 0x0F 0xE3 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PAVGW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0xE4: /* 0Fh E4h PMULHUW mmx(reg),mmx(r/m)      spec: 0x0F 0xE4 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMULHUW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
...
/* Opcodes starting with 0Fh E7h */
                switch (mrm.byte) {
                    ...
                    case 0xBF: /* 0Fh E7h BFh MOVNTQ mmx(r/m),mmx(reg) mod=2 reg=7 rm=7      spec: 0x0F 0xE7 mod/reg/rm mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVNTQ %s,MM%u",IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""),mrm.reg());
                        break;
...
/* End of opcodes starting with 0Fh E7h */
            ...
            case 0xEA: /* 0Fh EAh PMINSW mmx(reg),mmx(r/m)      spec: 0x0F 0xEA mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMINSW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xEE: /* 0Fh EEh PMAXSW mmx(reg),mmx(r/m)      spec: 0x0F 0xEE mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMAXSW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0xF6: /* 0Fh F6h PSADBW mmx(reg),mmx(r/m)      spec: 0x0F 0xF6 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSADBW MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
...
/* Opcodes starting with 0Fh F7h */
                switch (mrm.byte) {
                    ...
                    case 0xFF: /* 0Fh F7h FFh MASKMOVQ mmx(reg),mmx(r/m) mod=3 reg=7 rm=7      spec: 0x0F 0xF7 mod/reg/rm mod==3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MASKMOVQ MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                        break;
                    default:
                        goto _x86decode_illegal_opcode;
                };
