...
/* End of opcodes starting with 0Fh 23h */
            ...
            case 0x50: /* 0Fh 50h PAVEB mmx(reg),mmx(r/m)      spec: 0x0F 0x50 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PAVEB MM%u,%s",mrm.reg(),IPDecPrint32(mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x51: /* 0Fh 51h PADDSIW mmx(reg),mmx(r/m)      spec: 0x0F 0x51 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PADDSIW MM%u,%s",mrm.reg(),IPDecPrint32(mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x52: /* 0Fh 52h PMAGW mmx(reg),mmx(r/m)      spec: 0x0F 0x52 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMAGW MM%u,%s",mrm.reg(),IPDecPrint32(mrm,sib,disp,8,RC_MMXREG,""));
                break;
            /* opcode 0Fh 53h  not defined */
            case 0x54: /* 0Fh 54h PDISTIB mmx(reg),mmx(r/m)      spec: 0x0F 0x54 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PDISTIB MM%u,%s",mrm.reg(),IPDecPrint32(mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x55: /* 0Fh 55h PSUBSIW mmx(reg),mmx(r/m)      spec: 0x0F 0x55 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PSUBSIW MM%u,%s",mrm.reg(),IPDecPrint32(mrm,sib,disp,8,RC_MMXREG,""));
                break;
            /* opcode 0Fh 56h  not defined */
            /* opcode 0Fh 57h  not defined */
            case 0x58: /* 0Fh 58h PMVZB mmx(reg),mmx(r/m)      spec: 0x0F 0x58 mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMVZB MM%u,%s",mrm.reg(),IPDecPrint32(mrm,sib,disp,8,RC_MMXREG,""));
                break;
            ...
            case 0x5A: /* 0Fh 5Ah PMVNZB mmx(reg),mmx(r/m)      spec: 0x0F 0x5A mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMVNZB MM%u,%s",mrm.reg(),IPDecPrint32(mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x5B: /* 0Fh 5Bh PMVLZB mmx(reg),mmx(r/m)      spec: 0x0F 0x5B mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMVLZB MM%u,%s",mrm.reg(),IPDecPrint32(mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x5C: /* 0Fh 5Ch PMVGEZB mmx(reg),mmx(r/m)      spec: 0x0F 0x5C mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMVGEZB MM%u,%s",mrm.reg(),IPDecPrint32(mrm,sib,disp,8,RC_MMXREG,""));
                break;
            case 0x5D: /* 0Fh 5Dh PMULHRIW mmx(reg),mmx(r/m)      spec: 0x0F 0x5D mod/reg/rm */
                IPFB_mrm_sib_disp_a32_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMULHRIW MM%u,%s",mrm.reg(),IPDecPrint32(mrm,sib,disp,8,RC_MMXREG,""));
                break;
...
/* Opcodes starting with 0Fh 5Eh */
                switch (mrm.byte) {
                    ...
                    case 0xBF: /* 0Fh 5Eh BFh PMACHRIW mmx(reg),mmx(r/m) mod=2 reg=7 rm=7      spec: 0x0F 0x5E mod/reg/rm mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PMACHRIW MM%u,%s",mrm.reg(),IPDecPrint32(mrm,sib,disp,8,RC_MMXREG,""));
                        break;
