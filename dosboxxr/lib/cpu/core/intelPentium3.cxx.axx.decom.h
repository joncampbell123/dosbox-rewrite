...
op=IPFB();
_x86decode_begin_code32_addr32_opcode_parse__generic:
switch (op) {
...
/* Opcodes starting with 0Fh */
        op=IPFB();
        _x86decode_begin_code32_addr32_opcode_parse_0F_generic:
        switch (op) {
...
/* End of opcodes starting with 0Fh 01h */
            ...
            case 0x10: /* 0Fh 10h MOVUPS sse(reg),sse(r/m)      spec: 0x0F 0x10 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVUPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x11: /* 0Fh 11h MOVUPS sse(r/m),sse(reg)      spec: 0x0F 0x11 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVUPS %s,XMM%u",IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""),mrm.reg());
                break;
...
/* Opcodes starting with 0Fh 12h */
                switch (mrm.byte) {
                    ...
                    case 0xBF: /* 0Fh 12h BFh MOVLPS sse(reg),sse(r/m) mod=2 reg=7 rm=7      spec: 0x0F 0x12 mod/reg/rm mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVLPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                        break;
                    ...
                    case 0xFF: /* 0Fh 12h FFh MOVHLPS sse(reg),sse(r/m) mod=3 reg=7 rm=7      spec: 0x0F 0x12 mod/reg/rm mod==3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVHLPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                        break;
                    default:
                        goto _x86decode_illegal_opcode;
                };
...
/* Opcodes starting with 0Fh 13h */
                switch (mrm.byte) {
                    ...
                    case 0xBF: /* 0Fh 13h BFh MOVLPS sse(r/m),sse(reg) mod=2 reg=7 rm=7      spec: 0x0F 0x13 mod/reg/rm mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVLPS %s,XMM%u",IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""),mrm.reg());
                        break;
...
/* End of opcodes starting with 0Fh 13h */
            ...
            case 0x14: /* 0Fh 14h UNPCKLPS sse(reg),sse(r/m)      spec: 0x0F 0x14 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"UNPCKLPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x15: /* 0Fh 15h UNPCKHPS sse(reg),sse(r/m)      spec: 0x0F 0x15 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"UNPCKHPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
...
/* Opcodes starting with 0Fh 16h */
                switch (mrm.byte) {
                    ...
                    case 0xBF: /* 0Fh 16h BFh MOVHPS sse(reg),sse(r/m) mod=2 reg=7 rm=7      spec: 0x0F 0x16 mod/reg/rm mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVHPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                        break;
                    ...
                    case 0xFF: /* 0Fh 16h FFh MOVLHPS sse(reg),sse(r/m) mod=3 reg=7 rm=7      spec: 0x0F 0x16 mod/reg/rm mod==3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVLHPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                        break;
                    default:
                        goto _x86decode_illegal_opcode;
                };
...
/* Opcodes starting with 0Fh 17h */
                switch (mrm.byte) {
                    ...
                    case 0xBF: /* 0Fh 17h BFh MOVHPS sse(r/m),sse(reg) mod=2 reg=7 rm=7      spec: 0x0F 0x17 mod/reg/rm mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVHPS %s,XMM%u",IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""),mrm.reg());
                        break;
...
/* Opcodes starting with 0Fh 18h */
                switch (mrm.byte) {
                    ...
                    case 0x87: /* 0Fh 18h 87h PREFETCHNTA b(r/m) mod=2 reg=0 rm=7      spec: 0x0F 0x18 mod/reg/rm /0 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PREFETCHNTA %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                        break;
                    ...
                    case 0x8F: /* 0Fh 18h 8Fh PREFETCHT0 b(r/m) mod=2 reg=1 rm=7      spec: 0x0F 0x18 mod/reg/rm /1 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PREFETCHT0 %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                        break;
                    ...
                    case 0x97: /* 0Fh 18h 97h PREFETCHT1 b(r/m) mod=2 reg=2 rm=7      spec: 0x0F 0x18 mod/reg/rm /2 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PREFETCHT1 %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                        break;
                    ...
                    case 0x9F: /* 0Fh 18h 9Fh PREFETCHT2 b(r/m) mod=2 reg=3 rm=7      spec: 0x0F 0x18 mod/reg/rm /3 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PREFETCHT2 %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                        break;
...
/* End of opcodes starting with 0Fh 23h */
            ...
            case 0x28: /* 0Fh 28h MOVAPS sse(reg),sse(r/m)      spec: 0x0F 0x28 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVAPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x29: /* 0Fh 29h MOVAPS sse(r/m),sse(reg)      spec: 0x0F 0x29 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVAPS %s,XMM%u",IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""),mrm.reg());
                break;
            case 0x2A: /* 0Fh 2Ah CVTPI2PS sse(reg),mmx(r/m)      spec: 0x0F 0x2A mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CVTPI2PS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""));
                break;
...
/* Opcodes starting with 0Fh 2Bh */
                switch (mrm.byte) {
                    ...
                    case 0xBF: /* 0Fh 2Bh BFh MOVNTPS sse(r/m),sse(reg) mod=2 reg=7 rm=7      spec: 0x0F 0x2B mod/reg/rm mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVNTPS %s,XMM%u",IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""),mrm.reg());
                        break;
...
/* End of opcodes starting with 0Fh 2Bh */
            ...
            case 0x2C: /* 0Fh 2Ch CVTTPS2PI mmx(reg),sse(r/m)      spec: 0x0F 0x2C mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CVTTPS2PI MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x2D: /* 0Fh 2Dh CVTPS2PI mmx(reg),sse(r/m)      spec: 0x0F 0x2D mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CVTPS2PI MM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x2E: /* 0Fh 2Eh UCOMISS sse(reg),sse(r/m)      spec: 0x0F 0x2E mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"UCOMISS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x2F: /* 0Fh 2Fh COMISS sse(reg),sse(r/m)      spec: 0x0F 0x2F mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"COMISS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            ...
            case 0x40: /* 0Fh 40h CMOVO w(reg),w(r/m)      spec: 0x0F 0x40 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVO %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x41: /* 0Fh 41h CMOVNO w(reg),w(r/m)      spec: 0x0F 0x41 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVNO %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x42: /* 0Fh 42h CMOVB w(reg),w(r/m)      spec: 0x0F 0x42 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVB %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x43: /* 0Fh 43h CMOVNB w(reg),w(r/m)      spec: 0x0F 0x43 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVNB %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x44: /* 0Fh 44h CMOVZ w(reg),w(r/m)      spec: 0x0F 0x44 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVZ %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x45: /* 0Fh 45h CMOVNZ w(reg),w(r/m)      spec: 0x0F 0x45 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVNZ %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x46: /* 0Fh 46h CMOVBE w(reg),w(r/m)      spec: 0x0F 0x46 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVBE %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x47: /* 0Fh 47h CMOVNBE w(reg),w(r/m)      spec: 0x0F 0x47 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVNBE %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x48: /* 0Fh 48h CMOVS w(reg),w(r/m)      spec: 0x0F 0x48 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVS %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x49: /* 0Fh 49h CMOVNS w(reg),w(r/m)      spec: 0x0F 0x49 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVNS %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x4A: /* 0Fh 4Ah CMOVP w(reg),w(r/m)      spec: 0x0F 0x4A mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVP %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x4B: /* 0Fh 4Bh CMOVNP w(reg),w(r/m)      spec: 0x0F 0x4B mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVNP %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x4C: /* 0Fh 4Ch CMOVL w(reg),w(r/m)      spec: 0x0F 0x4C mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVL %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x4D: /* 0Fh 4Dh CMOVNL w(reg),w(r/m)      spec: 0x0F 0x4D mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVNL %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x4E: /* 0Fh 4Eh CMOVLE w(reg),w(r/m)      spec: 0x0F 0x4E mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVLE %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
            case 0x4F: /* 0Fh 4Fh CMOVNLE w(reg),w(r/m)      spec: 0x0F 0x4F mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMOVNLE %s,%s",CPUregsN[code32?4:2][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                break;
...
/* Opcodes starting with 0Fh 50h */
                switch (mrm.byte) {
                    ...
                    case 0xFF: /* 0Fh 50h FFh MOVMSKPS w32(reg),sse(r/m) mod=3 reg=7 rm=7      spec: 0x0F 0x50 mod/reg/rm mod==3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVMSKPS %s,%s",CPUregsN[4][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                        break;
                    default:
                        goto _x86decode_illegal_opcode;
                };
/* End of opcodes starting with 0Fh 50h */
            ...
            case 0x51: /* 0Fh 51h SQRTPS sse(reg),sse(r/m)      spec: 0x0F 0x51 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SQRTPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x52: /* 0Fh 52h RSQRTPS sse(reg),sse(r/m)      spec: 0x0F 0x52 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RSQRTPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x53: /* 0Fh 53h RCPPS sse(reg),sse(r/m)      spec: 0x0F 0x53 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCPPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x54: /* 0Fh 54h ANDPS sse(reg),sse(r/m)      spec: 0x0F 0x54 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ANDPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x55: /* 0Fh 55h ANDNPS sse(reg),sse(r/m)      spec: 0x0F 0x55 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ANDNPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x56: /* 0Fh 56h ORPS sse(reg),sse(r/m)      spec: 0x0F 0x56 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ORPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x57: /* 0Fh 57h XORPS sse(reg),sse(r/m)      spec: 0x0F 0x57 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"XORPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x58: /* 0Fh 58h ADDPS sse(reg),sse(r/m)      spec: 0x0F 0x58 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADDPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x59: /* 0Fh 59h MULPS sse(reg),sse(r/m)      spec: 0x0F 0x59 mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MULPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            ...
            case 0x5C: /* 0Fh 5Ch SUBPS sse(reg),sse(r/m)      spec: 0x0F 0x5C mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUBPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x5D: /* 0Fh 5Dh MINPS sse(reg),sse(r/m)      spec: 0x0F 0x5D mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MINPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x5E: /* 0Fh 5Eh DIVPS sse(reg),sse(r/m)      spec: 0x0F 0x5E mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"DIVPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x5F: /* 0Fh 5Fh MAXPS sse(reg),sse(r/m)      spec: 0x0F 0x5F mod/reg/rm */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MAXPS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
...
/* Opcodes starting with 0Fh AEh */
                switch (mrm.byte) {
                    ...
                    case 0xC7: /* 0Fh AEh C7h FXSAVE b(r/m) mod=3 reg=0 rm=7      spec: 0x0F 0xAE mod/reg/rm /0 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FXSAVE %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                        break;
                    ...
                    case 0xCF: /* 0Fh AEh CFh FXRSTOR b(r/m) mod=3 reg=1 rm=7      spec: 0x0F 0xAE mod/reg/rm /1 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FXRSTOR %s",IPDecPrint1632(addr32,mrm,sib,disp,1,RC_REG,"b"));
                        break;
                    ...
                    case 0x97: /* 0Fh AEh 97h LDMXCSR w(r/m) mod=2 reg=2 rm=7      spec: 0x0F 0xAE mod/reg/rm /2 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"LDMXCSR %s",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
                    ...
                    case 0x9F: /* 0Fh AEh 9Fh STMXCSR w(r/m) mod=2 reg=3 rm=7      spec: 0x0F 0xAE mod/reg/rm /3 mod!=3 */
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"STMXCSR %s",IPDecPrint1632(addr32,mrm,sib,disp,code32?4:2,RC_REG,code32?"d":"w"));
                        break;
...
/* End of opcodes starting with 0Fh BAh */
            ...
            case 0xC2: /* 0Fh C2h CMPPS sse(reg),sse(r/m),i      spec: 0x0F 0xC2 mod/reg/rm ib */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPPS XMM%u,%s,0x%02lX",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
...
/* Opcodes starting with 0Fh C4h */
                switch (mrm.byte) {
                    ...
                    case 0xBF: /* 0Fh C4h BFh PINSRW mmx(reg),w16(r/m),i mod=2 reg=7 rm=7      spec: 0x0F 0xC4 mod/reg/rm ib mod!=3 */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PINSRW MM%u,%s,0x%02lX",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    ...
                    case 0xFF: /* 0Fh C4h FFh PINSRW mmx(reg),w32(r/m),i mod=3 reg=7 rm=7      spec: 0x0F 0xC4 mod/reg/rm ib mod==3 */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PINSRW MM%u,%s,0x%02lX",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    default:
                        goto _x86decode_illegal_opcode;
                };
...
/* Opcodes starting with 0Fh C5h */
                switch (mrm.byte) {
                    ...
                    case 0xFF: /* 0Fh C5h FFh PEXTRW w32(reg),mmx(r/m),i mod=3 reg=7 rm=7      spec: 0x0F 0xC5 mod/reg/rm ib mod==3 */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PEXTRW %s,%s,0x%02lX",CPUregsN[4][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,8,RC_MMXREG,""),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    default:
                        goto _x86decode_illegal_opcode;
                };
...
/* End of opcodes starting with 62h */
    ...
    case 0x66: /* 66h        spec: 0x66 prefix opsz32 */
        ...
        op=IPFB();
        if (op != 0x0F) goto _x86decode_begin_code32_addr32_opcode_parse__generic;
...
/* Opcodes starting with 66h 0Fh C4h */
                switch (mrm.byte) {
                    ...
                    case 0xBF: /* 66h 0Fh C4h BFh PINSRW sse(reg),w16(r/m),i mod=2 reg=7 rm=7      spec: 0x0F 0xC4 mod/reg/rm ib mod!=3 mprefix(0x66) */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PINSRW XMM%u,%s,0x%02lX",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,2,RC_REG,"w16"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    ...
                    case 0xFF: /* 66h 0Fh C4h FFh PINSRW sse(reg),w32(r/m),i mod=3 reg=7 rm=7      spec: 0x0F 0xC4 mod/reg/rm ib mod==3 mprefix(0x66) */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PINSRW XMM%u,%s,0x%02lX",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    default:
                        goto _x86decode_illegal_opcode;
                };
...
/* Opcodes starting with 66h 0Fh C5h */
                switch (mrm.byte) {
                    ...
                    case 0xFF: /* 66h 0Fh C5h FFh PEXTRW w32(reg),sse(r/m),i mod=3 reg=7 rm=7      spec: 0x0F 0xC5 mod/reg/rm ib mod==3 mprefix(0x66) */
                        imm=IPFB();
                        ipw += snprintf(ipw,(size_t)(ipwf-ipw),"PEXTRW %s,%s,0x%02lX",CPUregsN[4][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                        break;
                    default:
                        goto _x86decode_illegal_opcode;
                };
...
/* Opcodes starting with DAh */
        switch (mrm.byte) {
            ...
            case 0xC7: /* DAh C7h FCMOVB st(0),st(r/m) mod=3 reg=0 rm=7      spec: 0xDA mod/reg/rm /0 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCMOVB ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xCF: /* DAh CFh FCMOVE st(0),st(r/m) mod=3 reg=1 rm=7      spec: 0xDA mod/reg/rm /1 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCMOVE ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xD7: /* DAh D7h FCMOVBE st(0),st(r/m) mod=3 reg=2 rm=7      spec: 0xDA mod/reg/rm /2 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCMOVBE ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xDF: /* DAh DFh FCMOVU st(0),st(r/m) mod=3 reg=3 rm=7      spec: 0xDA mod/reg/rm /3 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCMOVU ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
...
/* Opcodes starting with DBh */
        switch (mrm.byte) {
            ...
            case 0xC7: /* DBh C7h FCMOVNB st(0),st(r/m) mod=3 reg=0 rm=7      spec: 0xDB mod/reg/rm /0 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCMOVNB ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xCF: /* DBh CFh FCMOVNE st(0),st(r/m) mod=3 reg=1 rm=7      spec: 0xDB mod/reg/rm /1 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCMOVNE ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xD7: /* DBh D7h FCMOVNBE st(0),st(r/m) mod=3 reg=2 rm=7      spec: 0xDB mod/reg/rm /2 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCMOVNBE ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xDF: /* DBh DFh FCMOVNU st(0),st(r/m) mod=3 reg=3 rm=7      spec: 0xDB mod/reg/rm /3 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCMOVNU ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xEF: /* DBh EFh FUCOMI st(0),st(r/m) mod=3 reg=5 rm=7      spec: 0xDB mod/reg/rm /5 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FUCOMI ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xF7: /* DBh F7h FCOMI st(0),st(r/m) mod=3 reg=6 rm=7      spec: 0xDB mod/reg/rm /6 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCOMI ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
...
/* Opcodes starting with DFh */
        switch (mrm.byte) {
            ...
            case 0xEF: /* DFh EFh FUCOMIP st(0),st(r/m) mod=3 reg=5 rm=7      spec: 0xDF mod/reg/rm /5 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FUCOMIP ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
            ...
            case 0xF7: /* DFh F7h FCOMIP st(0),st(r/m) mod=3 reg=6 rm=7      spec: 0xDF mod/reg/rm /6 mod==3 */
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"FCOMIP ST(%u),%s",0,IPDecPrint1632(addr32,mrm,sib,disp,8,RC_FPUREG,""));
                break;
        ...
        switch (op=IPFB()) {
            ...
            case 0x10: /* F3h 0Fh 10h MOVSS sse(reg),sse(r/m)      spec: 0x0F 0x10 mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVSS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x11: /* F3h 0Fh 11h MOVSS sse(r/m),sse(reg)      spec: 0x0F 0x11 mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVSS %s,XMM%u",IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""),mrm.reg());
                break;
            ...
            case 0x2A: /* F3h 0Fh 2Ah CVTSI2SS sse(reg),w32(r/m)      spec: 0x0F 0x2A mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CVTSI2SS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,4,RC_REG,"w32"));
                break;
            ...
            case 0x2C: /* F3h 0Fh 2Ch CVTTSS2SI w32(reg),sse(r/m)      spec: 0x0F 0x2C mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CVTTSS2SI %s,%s",CPUregsN[4][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x2D: /* F3h 0Fh 2Dh CVTSS2SI w32(reg),sse(r/m)      spec: 0x0F 0x2D mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CVTSS2SI %s,%s",CPUregsN[4][mrm.reg()],IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            ...
            case 0x51: /* F3h 0Fh 51h SQRTSS sse(reg),sse(r/m)      spec: 0x0F 0x51 mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SQRTSS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x52: /* F3h 0Fh 52h RSQRTSS sse(reg),sse(r/m)      spec: 0x0F 0x52 mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RSQRTSS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x53: /* F3h 0Fh 53h RCPSS sse(reg),sse(r/m)      spec: 0x0F 0x53 mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"RCPSS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            ...
            case 0x58: /* F3h 0Fh 58h ADDSS sse(reg),sse(r/m)      spec: 0x0F 0x58 mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"ADDSS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x59: /* F3h 0Fh 59h MULSS sse(reg),sse(r/m)      spec: 0x0F 0x59 mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MULSS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            ...
            case 0x5C: /* F3h 0Fh 5Ch SUBSS sse(reg),sse(r/m)      spec: 0x0F 0x5C mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"SUBSS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x5D: /* F3h 0Fh 5Dh MINSS sse(reg),sse(r/m)      spec: 0x0F 0x5D mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MINSS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x5E: /* F3h 0Fh 5Eh DIVSS sse(reg),sse(r/m)      spec: 0x0F 0x5E mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"DIVSS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            case 0x5F: /* F3h 0Fh 5Fh MAXSS sse(reg),sse(r/m)      spec: 0x0F 0x5F mod/reg/rm mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MAXSS XMM%u,%s",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""));
                break;
            ...
            case 0xC2: /* F3h 0Fh C2h CMPSS sse(reg),sse(r/m),i      spec: 0x0F 0xC2 mod/reg/rm ib mprefix(0xF3) */
                if (addr32)
                    ...
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                imm=IPFB();
                ipw += snprintf(ipw,(size_t)(ipwf-ipw),"CMPSS XMM%u,%s,0x%02lX",mrm.reg(),IPDecPrint1632(addr32,mrm,sib,disp,16,RC_SSEREG,""),(unsigned long)((uint32_t)imm)&(code32?0xFFFFFFFFUL:0xFFFFUL));
                break;
