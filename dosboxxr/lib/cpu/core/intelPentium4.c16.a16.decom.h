...
/* Opcodes starting with 66h 0Fh */
            switch (op=IPFB()) {
                ...
                case 0x10: /* 66h 0Fh 10h MOVUPD sse(reg),sse(r/m)      spec: 0x0F 0x10 mod/reg/rm mprefix(0x66) */
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                    ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVUPD XMM%u,%s",mrm.reg(),IPDecPrint16(mrm,disp,16,RC_SSEREG,""));
                    break;
                case 0x11: /* 66h 0Fh 11h MOVUPD sse(r/m),sse(reg)      spec: 0x0F 0x11 mod/reg/rm mprefix(0x66) */
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                    ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVUPD %s,XMM%u",IPDecPrint16(mrm,disp,16,RC_SSEREG,""),mrm.reg());
                    break;
                case 0x12: /* 66h 0Fh 12h MOVLPD sse(reg),sse(r/m)      spec: 0x0F 0x12 mod/reg/rm mprefix(0x66) */
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                    ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVLPD XMM%u,%s",mrm.reg(),IPDecPrint16(mrm,disp,16,RC_SSEREG,""));
                    break;
...
/* End of opcodes starting with 66h 0Fh */
        ...
        else goto _x86decode_begin_code16_addr16_opcode_parse_;
        break;
...
/* Opcodes starting with F2h 0Fh */
            switch (op=IPFB()) {
                ...
                case 0x10: /* F2h 0Fh 10h MOVSD sse(reg),sse(r/m)      spec: 0x0F 0x10 mod/reg/rm mprefix(0xF2) */
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                    ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVSD XMM%u,%s",mrm.reg(),IPDecPrint16(mrm,disp,16,RC_SSEREG,""));
                    break;
                case 0x11: /* F2h 0Fh 11h MOVSD sse(r/m),sse(reg)      spec: 0x0F 0x11 mod/reg/rm mprefix(0xF2) */
                    IPFB_mrm_sib_disp_a16_read(mrm,sib,disp);
                    ipw += snprintf(ipw,(size_t)(ipwf-ipw),"MOVSD %s,XMM%u",IPDecPrint16(mrm,disp,16,RC_SSEREG,""),mrm.reg());
                    break;
                /* opcode F2h 0Fh 12h  not defined */
                ...
                /* opcode F2h 0Fh 38h  not defined */
                ...
                /* opcode F2h 0Fh 51h  not defined */
                ...
                /* opcode F2h 0Fh 58h  not defined */
                /* opcode F2h 0Fh 59h  not defined */
                /* opcode F2h 0Fh 5Ah  not defined */
                /* opcode F2h 0Fh 5Bh  not defined */
                /* opcode F2h 0Fh 5Ch  not defined */
                /* opcode F2h 0Fh 5Dh  not defined */
                /* opcode F2h 0Fh 5Eh  not defined */
                /* opcode F2h 0Fh 5Fh  not defined */
                ...
                /* opcode F2h 0Fh 70h  not defined */
                ...
                /* opcode F2h 0Fh 7Ch  not defined */
                /* opcode F2h 0Fh 7Dh  not defined */
                ...
                /* opcode F2h 0Fh C2h  not defined */
                ...
                /* opcode F2h 0Fh D0h  not defined */
                ...
                /* opcode F2h 0Fh D6h  not defined */
                ...
                /* opcode F2h 0Fh E6h  not defined */
                ...
                /* opcode F2h 0Fh F0h  not defined */
