; 80486/80487 test instruction set

    cpu     80486 FPU Undoc Obsolete
...
; CMPXCHG (old form, YASM won't encode it)
    db      0x0F,0xA6,0xD8
    db      0x0F,0xA6,0xCB
    db      0x0F,0xA6,0x14
    db      0x67,0x0F,0xA6,0x14,0x33

    db      0x0F,0xA7,0xD8
    db      0x0F,0xA7,0xCB
    db      0x0F,0xA7,0x14
    db      0x67,0x0F,0xA7,0x14,0x33
