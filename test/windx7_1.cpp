...
IDirectDrawSurface7*            ddsurfacePrimary = NULL;
IDirectDrawSurface7*            ddsurfaceGDI = NULL;    // Microsoft is very unclear about this: You can only get the GDI surface in fullscreen/exclusive. BUT, you can create a primary surface of the screen!
IDirectDrawSurface7*            ddsurfaceBMP = NULL;
...
int main(int argc,char **argv) {
    ...
    if ((hr=DirectDrawCreateEx(NULL,(void**)(&ddraw),IID_IDirectDraw7,NULL)) != DD_OK) {
